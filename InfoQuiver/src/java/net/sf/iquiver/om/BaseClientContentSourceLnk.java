 ...
 * extended all references should be to ClientContentSourceLnk
 */
public abstract class BaseClientContentSourceLnk extends BaseObject
{
    /** The Peer class */
    private static final ClientContentSourceLnkPeer peer =
        new ClientContentSourceLnkPeer();
    ...
    public Client getClient() throws TorqueException
    {
        if (aClient == null && (this.clientId > 0))
        {
            ...
            /* The following can be used instead of the line above to
               ...
               obj.addClientContentSourceLnks(this);
            */
        }
        return aClient;
    }
    ...
    {
          if (name.equals(ClientContentSourceLnkPeer.CLIENT_ID))
        {
                return new Integer(getClientId());
            }
          if (name.equals(ClientContentSourceLnkPeer.CONTENT_SOURCE_ID))
        {
                return new Long(getContentSourceId());
            }
          return null;
    ...
    {
          save(ClientContentSourceLnkPeer.getMapBuilder()
    ...
    public void save(Connection con) throws TorqueException
    {
          if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    ClientContentSourceLnkPeer.doInsert((ClientContentSourceLnk) this, con);
                    setNew(false);
                }
                else
                {
                    ClientContentSourceLnkPeer.doUpdate((ClientContentSourceLnk) this, con);
                }
            }
     ...
     *
         ...
         */
    public void setPrimaryKey( int clientId, long contentSourceId)
        throws TorqueException
    {
     ...
     * related objects to isNew=true.
       */
      public ClientContentSourceLnk copy() throws TorqueException
    {
        return copyInto(new ClientContentSourceLnk());
    }
  
    protected ClientContentSourceLnk copyInto(ClientContentSourceLnk copyObj) throws TorqueException
    {
     ...
     */
    public ClientContentSourceLnkPeer getPeer()
    {
        return peer;
    }
    ...
    public String toString()
    {
        ...
        str.append("ClientContentSourceLnk:\n");
        str.append("ClientId = ")
           .append(getClientId())
           .append("\n");
