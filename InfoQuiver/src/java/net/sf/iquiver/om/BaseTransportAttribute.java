...
public abstract class BaseTransportAttribute extends BaseObject
{
    ...
    /**
     * Declares an association between this object and a FetchTransport object
     *
     * @param v FetchTransport
    ...
    /**
     * Get the associated FetchTransport object
     *
     * @return the associated FetchTransport object
     * @throws TorqueException
     */
    public Transport getTransport() throws TorqueException
    {
        if (aTransport == null && (this.transportId > 0))
        {
            ...
            /* The following can be used instead of the line above to
               ...
               never be used.
               FetchTransport obj = TransportPeer.retrieveByPK(this.transportId);
