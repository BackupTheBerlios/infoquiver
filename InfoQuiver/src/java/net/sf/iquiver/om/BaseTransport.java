...
public abstract class BaseTransport extends BaseObject
{
    ...
    private int transportStartTimeout;
     ...
     * @return int
     */
    public int getTransportStartTimeout()
    {
     ...
     * @param v new value
     */
    public void setTransportStartTimeout(int v) 
    {
    
                  if (this.transportStartTimeout != v)
              {
     ...
     * actually need in Transport.
     */
    protected List getContentSourcesJoinContentType(Criteria criteria)
        throws TorqueException
    {
        if (collContentSources == null)
        {
            ...
            {
                            criteria.add(ContentSourcePeer.TRANSPORT_ID, getTransportId());
                            collContentSources = ContentSourcePeer.doSelectJoinContentType(criteria);
            }
        }
        else
        {
    ...
    public Object getByName(String name)
    {
        ...
        {
                return new Integer(getTransportStartTimeout());
            }
