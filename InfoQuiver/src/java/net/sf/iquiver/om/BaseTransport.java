 ...
 * extended all references should be to FetchTransport
 */
public abstract class BaseTransport extends BaseObject
{
     ...
     * Otherwise if this FetchTransport has previously
     * been saved, it will retrieve related TransportAttributes from storage.
     * If this FetchTransport is new, it will return
     ...
     * If this collection has already been initialized with
     * an identical criteria, it returns the collection.
     * Otherwise if this FetchTransport is new, it will return
     * an empty collection; or if this FetchTransport has previously
     * been saved, it will retrieve related TransportAttributes from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in FetchTransport.
     */
