...
import net.sf.iquiver.om.ContentSourceTypeTransportLnk;
 ...
 *
 */
public abstract class CacheBackedContentSourceTypeTransportLnkPeer
    extends net.sf.iquiver.om.BaseContentSourceTypeTransportLnkPeer
{
	...
	static
	{
		logger = LogFactory.getLog(CacheBackedContentSourceTypeTransportLnkPeer.class);
		CACHE_KEY = "${targetDBOPackage}.torque.${databaseName}.om.ContentSourceTypeTransportLnk";
		useCache = false;
		clear_crit = new Criteria();

		if(CacheBackedPeer.isEnabledAtStartup())
		{
    		if(CacheBackedPeer.getExcludeEnableAtStartUp() != null && !ArrayUtil.containsMatchingRegExString(CacheBackedPeer.getExcludeEnableAtStartUp(), "de.dat.u3.db.dbo.torque.cd.om.ContentSourceTypeTransportLnkPeer"))
    		{
				enableCache(true);
        	    if(CacheBackedPeer.isEnableCacheForCriteriaSelects())
        	    {
    				...
    				{
    					enableCacheForCriteriaSelects(!ArrayUtil.containsMatchingRegExString(CacheBackedPeer.getExcludeEnableCacheForCriteriaSelects(), "de.dat.u3.db.dbo.torque.cd.om.ContentSourceTypeTransportLnkPeer"));
    				}
    				else
    				{
	...
	private static ContentSourceTypeTransportLnk getObjectFromCache(ContentSourceTypeTransportLnk obj)
	{		
		ContentSourceTypeTransportLnk tmpObj = null;		
	...
	private static ContentSourceTypeTransportLnk getObjectFromCache(ObjectKey key) throws IllegalArgumentException
	{
		ContentSourceTypeTransportLnk tmpObj = null;
		...
		if(isCacheEnabled())
		{
			if (key != null && key.getValue() != null)
			{
				try
				{
					tmpObj = (ContentSourceTypeTransportLnk)cache.get(key);
				}
				catch(NullPointerException ne)
				{
	...
	private static void addObjectToCache(ObjectKey key, ContentSourceTypeTransportLnk obj)
	{
	...
	private static void addCriteriaResultListToCache(Criteria criteria, List objects)
	{
		...
		{
			ContentSourceTypeTransportLnk obj = (ContentSourceTypeTransportLnk)it.next();
			ObjectKey key = obj.getPrimaryKey();
			idList.add(key);
    ...
    /**
	 * Completes a partially populated ContentSourceTypeTransportLnk object by fetching the missing values from the database.<br>
	 * If the complete ContentSourceTypeTransportLnk is already stored in the object cache, the cached object will be returned<br>
     * As the case may be this method will add the fetched object to the cache	 
     * @param obj A partially populated ContentSourceTypeTransportLnk. <code>obj</code> will not be changed, this method returns a new object instead.
     * @return a ContentSourceTypeTransportLnk object containing all values available in the database.
     * @throws TorqueException
     */	 
	public static ContentSourceTypeTransportLnk doSelectSingle(ContentSourceTypeTransportLnk obj) throws TorqueException
	{			
		ContentSourceTypeTransportLnk tmpObj = getObjectFromCache(obj);
		
		if(tmpObj == null)
		{
			List objList = net.sf.iquiver.om.BaseContentSourceTypeTransportLnkPeer.doSelect(obj);
			if(objList != null && !objList.isEmpty())
			{
				tmpObj = (ContentSourceTypeTransportLnk)objList.get(0);
				if(tmpObj != null)
				{
    ...
    /**
	 * Fetches a list of ContentSourceTypeTransportLnks by a partially populated ContentSourceTypeTransportLnk object from the database.<br>
     ...
     * @throws TorqueException
     */	 
	public static List doSelect(ContentSourceTypeTransportLnk obj) throws TorqueException
	{			
		return doSelect(buildCriteria(obj));
	}
		
    /**
     * Fetches a list of ContentSourceTypeTransportLnks from the database by a given criteria<br>
     ...
     * @param crit
     * @return a list of ContentSourceTypeTransportLnks fetched from the database or cache
     * @throws TorqueException
     */	
	...
	public static List doSelect(final Criteria crit, Connection con) throws TorqueException
	{
		...
		{
			results = net.sf.iquiver.om.BaseContentSourceTypeTransportLnkPeer.doSelect(crit, con);
    ...
    /**
     * Fetches all ContentSourceTypeTransportLnks from the database<br>
    ...
    /**
     * Fetches a ContentSourceTypeTransportLnk from the database by a given primary key<br>
	 * If the ContentSourceTypeTransportLnk is already stored in the object cache, the cached object will be returned<br>
     * As the case may be this method will add the fetched object to the cache	 
     * @param key The primary key of the desired ContentSourceTypeTransportLnk
     * @return a ContentSourceTypeTransportLnk fetched from the database or cache
     * @throws TorqueException
     */	
	public static ContentSourceTypeTransportLnk retrieveByPK(ObjectKey key) throws TorqueException
	{
		ContentSourceTypeTransportLnk obj = getObjectFromCache(key);
		
		if(obj == null)
		{
			obj = net.sf.iquiver.om.BaseContentSourceTypeTransportLnkPeer.retrieveByPK(key);
			addObjectToCache(key, obj);
		}
     ...
     * @throws TorqueException
     */	
	public static ContentSourceTypeTransportLnk retrieveByPK(ObjectKey key, Connection con) throws TorqueException
	{
		ContentSourceTypeTransportLnk obj = getObjectFromCache(key);
		
		if(obj == null)
		{
			obj = net.sf.iquiver.om.BaseContentSourceTypeTransportLnkPeer.retrieveByPK(key, con);
			addObjectToCache(key, obj);
		}
    ...
    /**
     * Fetches multiple ContentSourceTypeTransportLnks from the database by a given list of primary keys<br>
    ...
    public static List retrieveByPKs( List pks, Connection dbcon ) throws TorqueException
    {
        ...
        else
        {
            ...
            while (iter.hasNext())
            {
                ...
                SimpleKey[] keys = (SimpleKey[])pk.getValue();
                        ...
                        CONTENT_SOURCE_TYPE_ID, keys[0], Criteria.EQUAL);
	    ...
	    /**
     * Fetches a ContentSourceTypeTransportLnk by it's primary key members from database or cache<br>
     * As the case may be this method will add the fetched object to the cache
     ...
     * @throws TorqueException
     */		    
	    public static ContentSourceTypeTransportLnk retrieveByPK(
   			int contentsourcetypeid	, 			int transportid			) throws TorqueException
    {
        Connection db = null;
        ContentSourceTypeTransportLnk retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
           retVal = retrieveByPK(
     ...
     */		    
	    public static ContentSourceTypeTransportLnk retrieveByPK(
   			int contentsourcetypeid	, 			int transportid		       ,Connection con) throws TorqueException
    {
		ContentSourceTypeTransportLnk obj = null;
		
					SimpleKey[] sKeys = new SimpleKey[]{
		   					SimpleKey.keyFor(contentsourcetypeid) , 							SimpleKey.keyFor(transportid) 						};
    ...
    /**
     * Deletes an ContentSourceTypeTransportLnk in the database, if the ContentSourceTypeTransportLnk is already stored in the object cache,<br>
     * it will be removed
     * @param obj
     * @throws TorqueException
     */
	public static void doDelete(ContentSourceTypeTransportLnk obj) throws TorqueException
	{		
		net.sf.iquiver.om.BaseContentSourceTypeTransportLnkPeer.doDelete(obj);
     ...
     * @throws TorqueException
     */
	public static void doDelete(ContentSourceTypeTransportLnk obj, Connection con) throws TorqueException
	{
		net.sf.iquiver.om.BaseContentSourceTypeTransportLnkPeer.doDelete(obj, con);
		removeObjectFromCache(obj.getPrimaryKey());		
	}
	
    /**
     * Deletes one or more ContentSourceTypeTransportLnks in the database.<br>
     * If the CriteriaResultListCache is enabled and does contain an list of primary keys for the given criteria, the idList<br>
     * will get removed from the CriteriaResultListCache and also the corresponding ContentSourceTypeTransportLnks will be removed<br>
	...
	{
		net.sf.iquiver.om.BaseContentSourceTypeTransportLnkPeer.doDelete(crit);
    ...
    /**
     * Deletes one or more ContentSourceTypeTransportLnks in the database.
     * If the CriteriaResultListCache is enabled and does contain an list of primary keys for the given criteria, the idList<br>
     * will get removed from the CriteriaResultListCache and also the corresponding ContentSourceTypeTransportLnks will be removed<br>
	...
	{
		net.sf.iquiver.om.BaseContentSourceTypeTransportLnkPeer.doDelete(crit, con);
		if(isCacheEnabled() && isCacheForCriteriaSelectsEnabled())
		{
			removeCriteriaResultListFromCache(crit);
		}
    ...
    /**
     * Deletes an ContentSourceTypeTransportLnk in the database by a given primary key<br>
     * If the ContentSourceTypeTransportLnk is already stored in the object cache, it will be removed
     * @param key
     * @throws TorqueException
     */	
	public static void doDelete(ObjectKey key) throws TorqueException
	{
		net.sf.iquiver.om.BaseContentSourceTypeTransportLnkPeer.doDelete(key);		
		removeObjectFromCache(key);				
	}		

    /**
     * Deletes an ContentSourceTypeTransportLnk in the database by a given primary key<br>
     * If the ContentSourceTypeTransportLnk is already stored in the object cache, it will be removed<br>
     * This method uses a existing Transaction          
     * @param key
     * @throws TorqueException
     */	
	...
	{
		net.sf.iquiver.om.BaseContentSourceTypeTransportLnkPeer.doDelete(key, con);			
		removeObjectFromCache(key);
	}		
   			...
   			int contentsourcetypeid	, 			int transportid		    ) throws TorqueException
    {
		Criteria crit = new Criteria();
	   				...
	   				crit.add(CONTENT_SOURCE_TYPE_ID, contentsourcetypeid);
    ...
    /**
     * Inserts or updates an ContentSourceTypeTransportLnk obj in the database<br>
     ...
     * @throws TorqueException
     */
	public static void doInsert(ContentSourceTypeTransportLnk obj) throws TorqueException
	{		
		removeObjectFromCache(obj.getPrimaryKey());
		net.sf.iquiver.om.BaseContentSourceTypeTransportLnkPeer.doInsert(obj);
		if(obj != null)
		{
     ...
     * @throws TorqueException
     */
	public static void doInsert(ContentSourceTypeTransportLnk obj, Connection con) throws TorqueException
	{
		removeObjectFromCache(obj.getPrimaryKey());
		net.sf.iquiver.om.BaseContentSourceTypeTransportLnkPeer.doInsert(obj, con);
		if(obj != null)
		{
			addObjectToCache(obj.getPrimaryKey(), obj);		
		}
