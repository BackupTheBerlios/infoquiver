...
{
	final private static Log logger = LogFactory.getLog(CacheBackedContentParserPeer.class);
	
	final public static String CACHE_KEY = "net.sf.iquiver.om.ContentParser";
