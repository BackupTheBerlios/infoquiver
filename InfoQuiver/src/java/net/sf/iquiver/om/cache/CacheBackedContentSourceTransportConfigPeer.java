...
{
	final private static Log logger = LogFactory.getLog(CacheBackedContentSourceTransportConfigPeer.class);
	
	final public static String CACHE_KEY = "net.sf.iquiver.om.ContentSourceTransportConfig";
