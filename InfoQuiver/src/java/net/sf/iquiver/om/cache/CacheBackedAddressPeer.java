 ...
 *
 */
public abstract class CacheBackedAddressPeer
    extends net.sf.iquiver.om.BaseAddressPeer
{
	...
	static
	{
		logger = LogFactory.getLog(CacheBackedAddressPeer.class);
		CACHE_KEY = "${targetDBOPackage}.torque.${databaseName}.om.Address";
		useCache = false;
		clear_crit = new Criteria();

		if(CacheBackedPeer.isEnabledAtStartup())
		{
    		if(CacheBackedPeer.getExcludeEnableAtStartUp() != null && !ArrayUtil.containsMatchingRegExString(CacheBackedPeer.getExcludeEnableAtStartUp(), "de.dat.u3.db.dbo.torque.cd.om.AddressPeer"))
    		{
				enableCache(true);
        	    if(CacheBackedPeer.isEnableCacheForCriteriaSelects())
        	    {
    				...
    				{
    					enableCacheForCriteriaSelects(!ArrayUtil.containsMatchingRegExString(CacheBackedPeer.getExcludeEnableCacheForCriteriaSelects(), "de.dat.u3.db.dbo.torque.cd.om.AddressPeer"));
    				}
    				else
    				{
	...
	private static Address getObjectFromCache(Address obj)
	{		
		Address tmpObj = null;		
	...
	private static Address getObjectFromCache(ObjectKey key) throws IllegalArgumentException
	{
		Address tmpObj = null;
	...
	private static void addObjectToCache(ObjectKey key, Address obj)
	{
    ...
    /**
	 * Completes a partially populated Address object by fetching the missing values from the database.<br>
	 * If the complete Address is already stored in the object cache, the cached object will be returned<br>
     * As the case may be this method will add the fetched object to the cache	 
     * @param obj A partially populated Address. <code>obj</code> will not be changed, this method returns a new object instead.
     * @return a Address object containing all values available in the database.
     * @throws TorqueException
     */	 
	public static Address doSelectSingle(Address obj) throws TorqueException
	{			
		Address tmpObj = getObjectFromCache(obj);
		
		if(tmpObj == null)
		{
			List objList = net.sf.iquiver.om.BaseAddressPeer.doSelect(obj);
			if(objList != null && !objList.isEmpty())
			{
				tmpObj = (Address)objList.get(0);
				if(tmpObj != null)
				{
    ...
    /**
	 * Fetches a list of Addresss by a partially populated Address object from the database.<br>
    ...
    /**
     * Fetches a list of Addresss from the database by a given criteria<br>
     ...
     * @param crit
     * @return a list of Addresss fetched from the database or cache
     * @throws TorqueException
     */	
	...
	public static List doSelect(final Criteria crit, Connection con) throws TorqueException
	{
		...
		{
			results = net.sf.iquiver.om.BaseAddressPeer.doSelect(crit, con);
    ...
    /**
     * Fetches all Addresss from the database<br>
     ...
     */
    public static Address retrieveByPK(long pk) throws TorqueException
    {
        return retrieveByPK(SimpleKey.keyFor(pk));
    }
  
    /**
     * Fetches a Address from the database by a given primary key<br>
	 * If the Address is already stored in the object cache, the cached object will be returned<br>
     * As the case may be this method will add the fetched object to the cache	 
     * @param key The primary key of the desired Address
     * @return a Address fetched from the database or cache
     * @throws TorqueException
     */	
	public static Address retrieveByPK(ObjectKey key) throws TorqueException
	{
		Address obj = getObjectFromCache(key);
		
		if(obj == null)
		{
			obj = net.sf.iquiver.om.BaseAddressPeer.retrieveByPK(key);
			addObjectToCache(key, obj);
		}
     ...
     * @throws TorqueException
     */	
	public static Address retrieveByPK(ObjectKey key, Connection con) throws TorqueException
	{
		Address obj = getObjectFromCache(key);
		
		if(obj == null)
		{
			obj = net.sf.iquiver.om.BaseAddressPeer.retrieveByPK(key, con);
			addObjectToCache(key, obj);
		}
    ...
    /**
     * Fetches multiple Addresss from the database by a given list of primary keys<br>
    ...
    /**
     * Deletes an Address in the database, if the Address is already stored in the object cache,<br>
     * it will be removed
     * @param obj
     * @throws TorqueException
     */
	...
	{		
		net.sf.iquiver.om.BaseAddressPeer.doDelete(obj);
     ...
     * @throws TorqueException
     */
	public static void doDelete(Address obj, Connection con) throws TorqueException
	{
		net.sf.iquiver.om.BaseAddressPeer.doDelete(obj, con);
		removeObjectFromCache(obj.getPrimaryKey());		
	}
	
    /**
     * Deletes one or more Addresss in the database.<br>
     * If the CriteriaResultListCache is enabled and does contain an list of primary keys for the given criteria, the idList<br>
     * will get removed from the CriteriaResultListCache and also the corresponding Addresss will be removed<br>
	...
	{
		net.sf.iquiver.om.BaseAddressPeer.doDelete(crit);
    ...
    /**
     * Deletes one or more Addresss in the database.
     * If the CriteriaResultListCache is enabled and does contain an list of primary keys for the given criteria, the idList<br>
     * will get removed from the CriteriaResultListCache and also the corresponding Addresss will be removed<br>
	...
	{
		net.sf.iquiver.om.BaseAddressPeer.doDelete(crit, con);
		if(isCacheEnabled() && isCacheForCriteriaSelectsEnabled())
		{
			removeCriteriaResultListFromCache(crit);
		}
    ...
    /**
     * Deletes an Address in the database by a given primary key<br>
     * If the Address is already stored in the object cache, it will be removed
     * @param key
     * @throws TorqueException
     */	
	public static void doDelete(ObjectKey key) throws TorqueException
	{
		net.sf.iquiver.om.BaseAddressPeer.doDelete(key);		
		removeObjectFromCache(key);				
	}		

    /**
     * Deletes an Address in the database by a given primary key<br>
     * If the Address is already stored in the object cache, it will be removed<br>
     * This method uses a existing Transaction          
     * @param key
     * @throws TorqueException
     */	
	...
	{
		net.sf.iquiver.om.BaseAddressPeer.doDelete(key, con);			
		removeObjectFromCache(key);
	}		
     ...
     */		    
	    public static void doDelete(
   			long addressid		    ) throws TorqueException
    {
		Criteria crit = new Criteria();
				
	   				crit.add(ADDRESS_ID, addressid);
				doDelete(crit);
		
		if(isCacheEnabled() && isCacheForCriteriaSelectsEnabled())
		{		
							SimpleKey oKey = SimpleKey.keyFor(addressid);
     ...
     */		    
	    public static void doDelete(
   			long addressid				, Connection con) throws TorqueException
	{
		Criteria crit = new Criteria();
	   				crit.add(ADDRESS_ID, addressid);
				net.sf.iquiver.om.BaseAddressPeer.doDelete(crit, con);
    ...
    /**
     * Inserts or updates an Address obj in the database<br>
	...
	{		
		removeObjectFromCache(obj.getPrimaryKey());
		net.sf.iquiver.om.BaseAddressPeer.doInsert(obj);
		if(obj != null)
		{
     ...
     * @throws TorqueException
     */
	public static void doInsert(Address obj, Connection con) throws TorqueException
	{
		removeObjectFromCache(obj.getPrimaryKey());
		net.sf.iquiver.om.BaseAddressPeer.doInsert(obj, con);
		if(obj != null)
		{
			addObjectToCache(obj.getPrimaryKey(), obj);		
		}
