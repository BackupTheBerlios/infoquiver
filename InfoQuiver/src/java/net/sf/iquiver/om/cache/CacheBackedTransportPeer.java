...
{
	final private static Log logger = LogFactory.getLog(CacheBackedTransportPeer.class);
	
	final public static String CACHE_KEY = "net.sf.iquiver.om.FetchTransport";
    ...
    /**
	 * Completes a partially populated FetchTransport object by fetching the missing values from the database.<br>
	 * If the complete FetchTransport is already stored in the object cache, the cached object will be returned<br>
     * As the case may be this method will add the fetched object to the cache	 
     * @param obj A partially populated FetchTransport. <code>obj</code> will not be changed, this method returns a new object instead.
     * @return a FetchTransport object containing all values available in the database.
    ...
    /**
	 * Fetches a list of Transports by a partially populated FetchTransport object from the database.<br>
    ...
    /**
     * Fetches a FetchTransport from the database by a given primary key<br>
	 * If the FetchTransport is already stored in the object cache, the cached object will be returned<br>
     * As the case may be this method will add the fetched object to the cache	 
     * @param key The primary key of the desired FetchTransport
     * @return a FetchTransport fetched from the database or cache
     * @throws TorqueException
     */	
    ...
    /**
     * Deletes an FetchTransport in the database, if the FetchTransport is already stored in the object cache,<br>
     * it will be removed
     * @param obj
     * @throws TorqueException
     */
    ...
    /**
     * Deletes an FetchTransport in the database by a given primary key<br>
     * If the FetchTransport is already stored in the object cache, it will be removed
     * @param key
     * @throws TorqueException
     */	
    ...
    /**
     * Deletes an FetchTransport in the database by a given primary key<br>
     * If the FetchTransport is already stored in the object cache, it will be removed<br>
     * This method uses a existing Transaction          
     * @param key
     * @throws TorqueException
     */	
    ...
    /**
     * Inserts or updates an FetchTransport obj in the database<br>
