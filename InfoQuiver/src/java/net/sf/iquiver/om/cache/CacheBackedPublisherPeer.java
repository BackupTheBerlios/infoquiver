...
import net.sf.iquiver.om.Publisher;
 ...
 *
 */
public abstract class CacheBackedPublisherPeer
    extends net.sf.iquiver.om.BasePublisherPeer
{
	...
	static
	{
		logger = LogFactory.getLog(CacheBackedPublisherPeer.class);
		CACHE_KEY = "${targetDBOPackage}.torque.${databaseName}.om.Publisher";
		useCache = false;
		clear_crit = new Criteria();

		if(CacheBackedPeer.isEnabledAtStartup())
		{
    		if(CacheBackedPeer.getExcludeEnableAtStartUp() != null && !ArrayUtil.containsMatchingRegExString(CacheBackedPeer.getExcludeEnableAtStartUp(), "de.dat.u3.db.dbo.torque.cd.om.PublisherPeer"))
    		{
				enableCache(true);
        	    if(CacheBackedPeer.isEnableCacheForCriteriaSelects())
        	    {
    				...
    				{
    					enableCacheForCriteriaSelects(!ArrayUtil.containsMatchingRegExString(CacheBackedPeer.getExcludeEnableCacheForCriteriaSelects(), "de.dat.u3.db.dbo.torque.cd.om.PublisherPeer"));
    				}
    				else
    				{
	...
	private static Publisher getObjectFromCache(Publisher obj)
	{		
		Publisher tmpObj = null;		
	...
	private static Publisher getObjectFromCache(ObjectKey key) throws IllegalArgumentException
	{
		Publisher tmpObj = null;
		...
		if(isCacheEnabled())
		{
			if (key != null && key.getValue() != null)
			{
				try
				{
					tmpObj = (Publisher)cache.get(key);
				}
				catch(NullPointerException ne)
				{
	...
	private static void addObjectToCache(ObjectKey key, Publisher obj)
	{
	...
	private static void addCriteriaResultListToCache(Criteria criteria, List objects)
	{
		...
		{
			Publisher obj = (Publisher)it.next();
			ObjectKey key = obj.getPrimaryKey();
			idList.add(key);
    ...
    /**
	 * Completes a partially populated Publisher object by fetching the missing values from the database.<br>
	 * If the complete Publisher is already stored in the object cache, the cached object will be returned<br>
     * As the case may be this method will add the fetched object to the cache	 
     * @param obj A partially populated Publisher. <code>obj</code> will not be changed, this method returns a new object instead.
     * @return a Publisher object containing all values available in the database.
     * @throws TorqueException
     */	 
	public static Publisher doSelectSingle(Publisher obj) throws TorqueException
	{			
		Publisher tmpObj = getObjectFromCache(obj);
		
		if(tmpObj == null)
		{
			List objList = net.sf.iquiver.om.BasePublisherPeer.doSelect(obj);
			if(objList != null && !objList.isEmpty())
			{
				tmpObj = (Publisher)objList.get(0);
				if(tmpObj != null)
				{
    ...
    /**
	 * Fetches a list of Publishers by a partially populated Publisher object from the database.<br>
     ...
     * @throws TorqueException
     */	 
	public static List doSelect(Publisher obj) throws TorqueException
	{			
		return doSelect(buildCriteria(obj));
	}
		
    /**
     * Fetches a list of Publishers from the database by a given criteria<br>
     ...
     * @param crit
     * @return a list of Publishers fetched from the database or cache
     * @throws TorqueException
     */	
	...
	public static List doSelect(final Criteria crit, Connection con) throws TorqueException
	{
		...
		{
			results = net.sf.iquiver.om.BasePublisherPeer.doSelect(crit, con);
    ...
    /**
     * Fetches all Publishers from the database<br>
     ...
     */
    public static Publisher retrieveByPK(int pk) throws TorqueException
    {
        return retrieveByPK(SimpleKey.keyFor(pk));
    }
  
    /**
     * Fetches a Publisher from the database by a given primary key<br>
	 * If the Publisher is already stored in the object cache, the cached object will be returned<br>
     * As the case may be this method will add the fetched object to the cache	 
     * @param key The primary key of the desired Publisher
     * @return a Publisher fetched from the database or cache
     * @throws TorqueException
     */	
	public static Publisher retrieveByPK(ObjectKey key) throws TorqueException
	{
		Publisher obj = getObjectFromCache(key);
		
		if(obj == null)
		{
			obj = net.sf.iquiver.om.BasePublisherPeer.retrieveByPK(key);
			addObjectToCache(key, obj);
		}
     ...
     * @throws TorqueException
     */	
	public static Publisher retrieveByPK(ObjectKey key, Connection con) throws TorqueException
	{
		Publisher obj = getObjectFromCache(key);
		
		if(obj == null)
		{
			obj = net.sf.iquiver.om.BasePublisherPeer.retrieveByPK(key, con);
			addObjectToCache(key, obj);
		}
    ...
    /**
     * Fetches multiple Publishers from the database by a given list of primary keys<br>
    ...
    public static List retrieveByPKs( List pks, Connection dbcon ) throws TorqueException
    {
        ...
        else
        {
            Criteria criteria = new Criteria();
              criteria.addIn( PUBLISHER_ID, pks );
    ...
    /**
     * Deletes an Publisher in the database, if the Publisher is already stored in the object cache,<br>
     * it will be removed
     * @param obj
     * @throws TorqueException
     */
	public static void doDelete(Publisher obj) throws TorqueException
	{		
		net.sf.iquiver.om.BasePublisherPeer.doDelete(obj);
     ...
     * @throws TorqueException
     */
	public static void doDelete(Publisher obj, Connection con) throws TorqueException
	{
		net.sf.iquiver.om.BasePublisherPeer.doDelete(obj, con);
		removeObjectFromCache(obj.getPrimaryKey());		
	}
	
    /**
     * Deletes one or more Publishers in the database.<br>
     * If the CriteriaResultListCache is enabled and does contain an list of primary keys for the given criteria, the idList<br>
     * will get removed from the CriteriaResultListCache and also the corresponding Publishers will be removed<br>
	...
	{
		net.sf.iquiver.om.BasePublisherPeer.doDelete(crit);
    ...
    /**
     * Deletes one or more Publishers in the database.
     * If the CriteriaResultListCache is enabled and does contain an list of primary keys for the given criteria, the idList<br>
     * will get removed from the CriteriaResultListCache and also the corresponding Publishers will be removed<br>
	...
	{
		net.sf.iquiver.om.BasePublisherPeer.doDelete(crit, con);
		if(isCacheEnabled() && isCacheForCriteriaSelectsEnabled())
		{
			removeCriteriaResultListFromCache(crit);
		}
    ...
    /**
     * Deletes an Publisher in the database by a given primary key<br>
     * If the Publisher is already stored in the object cache, it will be removed
     * @param key
     * @throws TorqueException
     */	
	public static void doDelete(ObjectKey key) throws TorqueException
	{
		net.sf.iquiver.om.BasePublisherPeer.doDelete(key);		
		removeObjectFromCache(key);				
	}		

    /**
     * Deletes an Publisher in the database by a given primary key<br>
     * If the Publisher is already stored in the object cache, it will be removed<br>
     * This method uses a existing Transaction          
     * @param key
     * @throws TorqueException
     */	
	...
	{
		net.sf.iquiver.om.BasePublisherPeer.doDelete(key, con);			
		removeObjectFromCache(key);
	}		
     ...
     */		    
	    public static void doDelete(
   			int publisherid		    ) throws TorqueException
    {
		Criteria crit = new Criteria();
				
	   				crit.add(PUBLISHER_ID, publisherid);
				doDelete(crit);
		
		if(isCacheEnabled() && isCacheForCriteriaSelectsEnabled())
		{		
							SimpleKey oKey = SimpleKey.keyFor(publisherid);
     ...
     */		    
	    public static void doDelete(
   			int publisherid				, Connection con) throws TorqueException
	{
		Criteria crit = new Criteria();
	   				crit.add(PUBLISHER_ID, publisherid);
				net.sf.iquiver.om.BasePublisherPeer.doDelete(crit, con);
    ...
    /**
     * Inserts or updates an Publisher obj in the database<br>
     ...
     * @throws TorqueException
     */
	public static void doInsert(Publisher obj) throws TorqueException
	{		
		removeObjectFromCache(obj.getPrimaryKey());
		net.sf.iquiver.om.BasePublisherPeer.doInsert(obj);
		if(obj != null)
		{
     ...
     * @throws TorqueException
     */
	public static void doInsert(Publisher obj, Connection con) throws TorqueException
	{
		removeObjectFromCache(obj.getPrimaryKey());
		net.sf.iquiver.om.BasePublisherPeer.doInsert(obj, con);
		if(obj != null)
		{
			addObjectToCache(obj.getPrimaryKey(), obj);		
		}
