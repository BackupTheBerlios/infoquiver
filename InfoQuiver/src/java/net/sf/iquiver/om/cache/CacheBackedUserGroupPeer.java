 ...
 */
public abstract class CacheBackedUserGroupPeer
    extends net.sf.iquiver.om.BaseUserGroupPeer
{
	...
	static
	{
		logger = LogFactory.getLog(CacheBackedUserGroupPeer.class);
		CACHE_KEY = "${targetDBOPackage}.torque.${databaseName}.om.UserGroup";
		useCache = false;
		clear_crit = new Criteria();

		if(CacheBackedPeer.isEnabledAtStartup())
		{
    		if(CacheBackedPeer.getExcludeEnableAtStartUp() != null && !ArrayUtil.containsMatchingRegExString(CacheBackedPeer.getExcludeEnableAtStartUp(), "de.dat.u3.db.dbo.torque.cd.om.UserGroupPeer"))
    		{
				enableCache(true);
        	    if(CacheBackedPeer.isEnableCacheForCriteriaSelects())
        	    {
    				...
    				{
    					enableCacheForCriteriaSelects(!ArrayUtil.containsMatchingRegExString(CacheBackedPeer.getExcludeEnableCacheForCriteriaSelects(), "de.dat.u3.db.dbo.torque.cd.om.UserGroupPeer"));
    				}
    				else
    				{
	...
	private static UserGroup getObjectFromCache(UserGroup obj)
	{		
		UserGroup tmpObj = null;		
	...
	private static UserGroup getObjectFromCache(ObjectKey key) throws IllegalArgumentException
	{
		UserGroup tmpObj = null;
		...
		if(isCacheEnabled())
		{
			if (key != null && key.getValue() != null)
			{
				try
				{
					tmpObj = (UserGroup)cache.get(key);
				}
				catch(NullPointerException ne)
				{
	...
	private static void addObjectToCache(ObjectKey key, UserGroup obj)
	{
	...
	private static void addCriteriaResultListToCache(Criteria criteria, List objects)
	{
		...
		{
			UserGroup obj = (UserGroup)it.next();
			ObjectKey key = obj.getPrimaryKey();
			idList.add(key);
    ...
    /**
	 * Completes a partially populated UserGroup object by fetching the missing values from the database.<br>
	 * If the complete UserGroup is already stored in the object cache, the cached object will be returned<br>
     * As the case may be this method will add the fetched object to the cache	 
     * @param obj A partially populated UserGroup. <code>obj</code> will not be changed, this method returns a new object instead.
     * @return a UserGroup object containing all values available in the database.
     * @throws TorqueException
     */	 
	public static UserGroup doSelectSingle(UserGroup obj) throws TorqueException
	{			
		UserGroup tmpObj = getObjectFromCache(obj);
		
		if(tmpObj == null)
		{
			List objList = net.sf.iquiver.om.BaseUserGroupPeer.doSelect(obj);
			if(objList != null && !objList.isEmpty())
			{
				tmpObj = (UserGroup)objList.get(0);
				if(tmpObj != null)
				{
    ...
    /**
	 * Fetches a list of UserGroups by a partially populated UserGroup object from the database.<br>
    ...
    /**
     * Fetches a list of UserGroups from the database by a given criteria<br>
     ...
     * @param crit
     * @return a list of UserGroups fetched from the database or cache
     * @throws TorqueException
     */	
	...
	public static List doSelect(final Criteria crit, Connection con) throws TorqueException
	{
		...
		{
			results = net.sf.iquiver.om.BaseUserGroupPeer.doSelect(crit, con);
    ...
    /**
     * Fetches all UserGroups from the database<br>
     ...
     */
    public static UserGroup retrieveByPK(long pk) throws TorqueException
    {
        return retrieveByPK(SimpleKey.keyFor(pk));
    }
  
    /**
     * Fetches a UserGroup from the database by a given primary key<br>
	 * If the UserGroup is already stored in the object cache, the cached object will be returned<br>
     * As the case may be this method will add the fetched object to the cache	 
     * @param key The primary key of the desired UserGroup
     * @return a UserGroup fetched from the database or cache
     * @throws TorqueException
     */	
	public static UserGroup retrieveByPK(ObjectKey key) throws TorqueException
	{
		UserGroup obj = getObjectFromCache(key);
		
		if(obj == null)
		{
			obj = net.sf.iquiver.om.BaseUserGroupPeer.retrieveByPK(key);
			addObjectToCache(key, obj);
		}
     ...
     * @throws TorqueException
     */	
	public static UserGroup retrieveByPK(ObjectKey key, Connection con) throws TorqueException
	{
		UserGroup obj = getObjectFromCache(key);
		
		if(obj == null)
		{
			obj = net.sf.iquiver.om.BaseUserGroupPeer.retrieveByPK(key, con);
			addObjectToCache(key, obj);
		}
    ...
    /**
     * Fetches multiple UserGroups from the database by a given list of primary keys<br>
    ...
    public static List retrieveByPKs( List pks, Connection dbcon ) throws TorqueException
    {
        ...
        else
        {
            Criteria criteria = new Criteria();
              criteria.addIn( USER_GROUP_ID, pks );
    ...
    /**
     * Deletes an UserGroup in the database, if the UserGroup is already stored in the object cache,<br>
     * it will be removed
     * @param obj
     * @throws TorqueException
     */
	...
	{		
		net.sf.iquiver.om.BaseUserGroupPeer.doDelete(obj);
     ...
     * @throws TorqueException
     */
	public static void doDelete(UserGroup obj, Connection con) throws TorqueException
	{
		net.sf.iquiver.om.BaseUserGroupPeer.doDelete(obj, con);
		removeObjectFromCache(obj.getPrimaryKey());		
	}
	
    /**
     * Deletes one or more UserGroups in the database.<br>
     * If the CriteriaResultListCache is enabled and does contain an list of primary keys for the given criteria, the idList<br>
     * will get removed from the CriteriaResultListCache and also the corresponding UserGroups will be removed<br>
	...
	{
		net.sf.iquiver.om.BaseUserGroupPeer.doDelete(crit);
    ...
    /**
     * Deletes one or more UserGroups in the database.
     * If the CriteriaResultListCache is enabled and does contain an list of primary keys for the given criteria, the idList<br>
     * will get removed from the CriteriaResultListCache and also the corresponding UserGroups will be removed<br>
	...
	{
		net.sf.iquiver.om.BaseUserGroupPeer.doDelete(crit, con);
		if(isCacheEnabled() && isCacheForCriteriaSelectsEnabled())
		{
			removeCriteriaResultListFromCache(crit);
		}
    ...
    /**
     * Deletes an UserGroup in the database by a given primary key<br>
     * If the UserGroup is already stored in the object cache, it will be removed
     * @param key
     * @throws TorqueException
     */	
	public static void doDelete(ObjectKey key) throws TorqueException
	{
		net.sf.iquiver.om.BaseUserGroupPeer.doDelete(key);		
		removeObjectFromCache(key);				
	}		

    /**
     * Deletes an UserGroup in the database by a given primary key<br>
     * If the UserGroup is already stored in the object cache, it will be removed<br>
     * This method uses a existing Transaction          
     * @param key
     * @throws TorqueException
     */	
	...
	{
		net.sf.iquiver.om.BaseUserGroupPeer.doDelete(key, con);			
		removeObjectFromCache(key);
	}		
     ...
     */		    
	    public static void doDelete(
   			long usergroupid		    ) throws TorqueException
    {
		...
		if(isCacheEnabled() && isCacheForCriteriaSelectsEnabled())
		{		
							SimpleKey oKey = SimpleKey.keyFor(usergroupid);
     ...
     */		    
	    public static void doDelete(
   			long usergroupid				, Connection con) throws TorqueException
	{
		Criteria crit = new Criteria();
	   				crit.add(USER_GROUP_ID, usergroupid);
				net.sf.iquiver.om.BaseUserGroupPeer.doDelete(crit, con);
    ...
    /**
     * Inserts or updates an UserGroup obj in the database<br>
	...
	{		
		removeObjectFromCache(obj.getPrimaryKey());
		net.sf.iquiver.om.BaseUserGroupPeer.doInsert(obj);
		if(obj != null)
		{
     ...
     * @throws TorqueException
     */
	public static void doInsert(UserGroup obj, Connection con) throws TorqueException
	{
		removeObjectFromCache(obj.getPrimaryKey());
		net.sf.iquiver.om.BaseUserGroupPeer.doInsert(obj, con);
		if(obj != null)
		{
			addObjectToCache(obj.getPrimaryKey(), obj);		
		}
