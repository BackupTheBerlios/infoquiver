...
{
	final private static Log logger = LogFactory.getLog(CacheBackedUserGroupClientLnkPeer.class);
	
	final public static String CACHE_KEY = "net.sf.iquiver.om.UserGroupClientLnk";
