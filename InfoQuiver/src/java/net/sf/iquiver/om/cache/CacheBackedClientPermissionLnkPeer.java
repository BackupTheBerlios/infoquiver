...
{
	final private static Log logger = LogFactory.getLog(CacheBackedClientPermissionLnkPeer.class);
	
	final public static String CACHE_KEY = "net.sf.iquiver.om.ClientPermissionLnk";
