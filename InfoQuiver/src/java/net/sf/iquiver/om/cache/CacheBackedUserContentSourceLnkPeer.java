    ...
    extends net.sf.iquiver.om.BaseUserContentSourceLnkPeer
{
	...
	static
	{
		...
		CACHE_KEY = "net.sf.iquiver.om.om.UserContentSourceLnk";
		useCache = false;
		clear_crit = new Criteria();

		if(CacheBackedPeer.isEnabledAtStartup())
		{
    		if(CacheBackedPeer.getExcludeEnableAtStartUp() != null && !ArrayUtil.containsMatchingRegExString(CacheBackedPeer.getExcludeEnableAtStartUp(), "net.sf.iquiver.om.UserContentSourceLnkPeer"))
    		{
				enableCache(true);
        	    if(CacheBackedPeer.isEnableCacheForCriteriaSelects())
        	    {
    				...
    				{
    					enableCacheForCriteriaSelects(!ArrayUtil.containsMatchingRegExString(CacheBackedPeer.getExcludeEnableCacheForCriteriaSelects(), "net.sf.iquiver.om.UserContentSourceLnkPeer"));
    				}
    				else
    				{
