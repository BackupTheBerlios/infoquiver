...
import net.sf.iquiver.om.UserContentSourceLnk;
 ...
 *
 */
public abstract class CacheBackedUserContentSourceLnkPeer
    extends net.sf.iquiver.om.BaseUserContentSourceLnkPeer
{
	...
	static
	{
		logger = LogFactory.getLog(CacheBackedUserContentSourceLnkPeer.class);
		CACHE_KEY = "${targetDBOPackage}.torque.${databaseName}.om.UserContentSourceLnk";
		useCache = false;
		clear_crit = new Criteria();

		if(CacheBackedPeer.isEnabledAtStartup())
		{
    		if(CacheBackedPeer.getExcludeEnableAtStartUp() != null && !ArrayUtil.containsMatchingRegExString(CacheBackedPeer.getExcludeEnableAtStartUp(), "de.dat.u3.db.dbo.torque.cd.om.UserContentSourceLnkPeer"))
    		{
				enableCache(true);
        	    if(CacheBackedPeer.isEnableCacheForCriteriaSelects())
        	    {
    				...
    				{
    					enableCacheForCriteriaSelects(!ArrayUtil.containsMatchingRegExString(CacheBackedPeer.getExcludeEnableCacheForCriteriaSelects(), "de.dat.u3.db.dbo.torque.cd.om.UserContentSourceLnkPeer"));
    				}
    				else
    				{
	...
	private static UserContentSourceLnk getObjectFromCache(UserContentSourceLnk obj)
	{		
		UserContentSourceLnk tmpObj = null;		
	...
	private static UserContentSourceLnk getObjectFromCache(ObjectKey key) throws IllegalArgumentException
	{
		UserContentSourceLnk tmpObj = null;
		...
		if(isCacheEnabled())
		{
			if (key != null && key.getValue() != null)
			{
				try
				{
					tmpObj = (UserContentSourceLnk)cache.get(key);
				}
				catch(NullPointerException ne)
				{
	...
	private static void addObjectToCache(ObjectKey key, UserContentSourceLnk obj)
	{
	...
	private static void addCriteriaResultListToCache(Criteria criteria, List objects)
	{
		...
		{
			UserContentSourceLnk obj = (UserContentSourceLnk)it.next();
			ObjectKey key = obj.getPrimaryKey();
			idList.add(key);
    ...
    /**
	 * Completes a partially populated UserContentSourceLnk object by fetching the missing values from the database.<br>
	 * If the complete UserContentSourceLnk is already stored in the object cache, the cached object will be returned<br>
     * As the case may be this method will add the fetched object to the cache	 
     * @param obj A partially populated UserContentSourceLnk. <code>obj</code> will not be changed, this method returns a new object instead.
     * @return a UserContentSourceLnk object containing all values available in the database.
     * @throws TorqueException
     */	 
	public static UserContentSourceLnk doSelectSingle(UserContentSourceLnk obj) throws TorqueException
	{			
		UserContentSourceLnk tmpObj = getObjectFromCache(obj);
		
		if(tmpObj == null)
		{
			List objList = net.sf.iquiver.om.BaseUserContentSourceLnkPeer.doSelect(obj);
			if(objList != null && !objList.isEmpty())
			{
				tmpObj = (UserContentSourceLnk)objList.get(0);
				if(tmpObj != null)
				{
    ...
    /**
	 * Fetches a list of UserContentSourceLnks by a partially populated UserContentSourceLnk object from the database.<br>
    ...
    /**
     * Fetches a list of UserContentSourceLnks from the database by a given criteria<br>
     ...
     * @param crit
     * @return a list of UserContentSourceLnks fetched from the database or cache
     * @throws TorqueException
     */	
	...
	public static List doSelect(final Criteria crit, Connection con) throws TorqueException
	{
		...
		{
			results = net.sf.iquiver.om.BaseUserContentSourceLnkPeer.doSelect(crit, con);
    ...
    /**
     * Fetches all UserContentSourceLnks from the database<br>
    ...
    /**
     * Fetches a UserContentSourceLnk from the database by a given primary key<br>
	 * If the UserContentSourceLnk is already stored in the object cache, the cached object will be returned<br>
     * As the case may be this method will add the fetched object to the cache	 
     * @param key The primary key of the desired UserContentSourceLnk
     * @return a UserContentSourceLnk fetched from the database or cache
     * @throws TorqueException
     */	
	public static UserContentSourceLnk retrieveByPK(ObjectKey key) throws TorqueException
	{
		UserContentSourceLnk obj = getObjectFromCache(key);
		
		if(obj == null)
		{
			obj = net.sf.iquiver.om.BaseUserContentSourceLnkPeer.retrieveByPK(key);
			addObjectToCache(key, obj);
		}
     ...
     * @throws TorqueException
     */	
	public static UserContentSourceLnk retrieveByPK(ObjectKey key, Connection con) throws TorqueException
	{
		UserContentSourceLnk obj = getObjectFromCache(key);
		
		if(obj == null)
		{
			obj = net.sf.iquiver.om.BaseUserContentSourceLnkPeer.retrieveByPK(key, con);
			addObjectToCache(key, obj);
		}
    ...
    /**
     * Fetches multiple UserContentSourceLnks from the database by a given list of primary keys<br>
    ...
    public static List retrieveByPKs( List pks, Connection dbcon ) throws TorqueException
    {
	    ...
	    /**
     * Fetches a UserContentSourceLnk by it's primary key members from database or cache<br>
     * As the case may be this method will add the fetched object to the cache
		 * @param userid
     ...
     */		    
	    public static UserContentSourceLnk retrieveByPK(
   			long userid	, 			long contentsourceid			) throws TorqueException
    {
        Connection db = null;
     ...
     */		    
	    public static UserContentSourceLnk retrieveByPK(
   			long userid	, 			long contentsourceid		       ,Connection con) throws TorqueException
    {
		UserContentSourceLnk obj = null;
		
					SimpleKey[] sKeys = new SimpleKey[]{
		   					SimpleKey.keyFor(userid) , 							SimpleKey.keyFor(contentsourceid) 						};
    ...
    /**
     * Deletes an UserContentSourceLnk in the database, if the UserContentSourceLnk is already stored in the object cache,<br>
     * it will be removed
     * @param obj
     * @throws TorqueException
     */
	...
	{		
		net.sf.iquiver.om.BaseUserContentSourceLnkPeer.doDelete(obj);
     ...
     * @throws TorqueException
     */
	public static void doDelete(UserContentSourceLnk obj, Connection con) throws TorqueException
	{
		net.sf.iquiver.om.BaseUserContentSourceLnkPeer.doDelete(obj, con);
		removeObjectFromCache(obj.getPrimaryKey());		
	}
	
    /**
     * Deletes one or more UserContentSourceLnks in the database.<br>
     * If the CriteriaResultListCache is enabled and does contain an list of primary keys for the given criteria, the idList<br>
     * will get removed from the CriteriaResultListCache and also the corresponding UserContentSourceLnks will be removed<br>
	...
	{
		net.sf.iquiver.om.BaseUserContentSourceLnkPeer.doDelete(crit);
    ...
    /**
     * Deletes one or more UserContentSourceLnks in the database.
     * If the CriteriaResultListCache is enabled and does contain an list of primary keys for the given criteria, the idList<br>
     * will get removed from the CriteriaResultListCache and also the corresponding UserContentSourceLnks will be removed<br>
	...
	{
		net.sf.iquiver.om.BaseUserContentSourceLnkPeer.doDelete(crit, con);
		if(isCacheEnabled() && isCacheForCriteriaSelectsEnabled())
		{
			removeCriteriaResultListFromCache(crit);
		}
    ...
    /**
     * Deletes an UserContentSourceLnk in the database by a given primary key<br>
     * If the UserContentSourceLnk is already stored in the object cache, it will be removed
     * @param key
     * @throws TorqueException
     */	
	public static void doDelete(ObjectKey key) throws TorqueException
	{
		net.sf.iquiver.om.BaseUserContentSourceLnkPeer.doDelete(key);		
		removeObjectFromCache(key);				
	}		

    /**
     * Deletes an UserContentSourceLnk in the database by a given primary key<br>
     * If the UserContentSourceLnk is already stored in the object cache, it will be removed<br>
     * This method uses a existing Transaction          
     * @param key
     * @throws TorqueException
     */	
	...
	{
		net.sf.iquiver.om.BaseUserContentSourceLnkPeer.doDelete(key, con);			
		removeObjectFromCache(key);
	}		
    ...
    /**
     * Inserts or updates an UserContentSourceLnk obj in the database<br>
	...
	{		
		removeObjectFromCache(obj.getPrimaryKey());
		net.sf.iquiver.om.BaseUserContentSourceLnkPeer.doInsert(obj);
		if(obj != null)
		{
     ...
     * @throws TorqueException
     */
	public static void doInsert(UserContentSourceLnk obj, Connection con) throws TorqueException
	{
		removeObjectFromCache(obj.getPrimaryKey());
		net.sf.iquiver.om.BaseUserContentSourceLnkPeer.doInsert(obj, con);
		if(obj != null)
		{
			addObjectToCache(obj.getPrimaryKey(), obj);		
		}
