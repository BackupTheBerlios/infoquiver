...
import net.sf.iquiver.om.ClientContentSourceLnk;
 ...
 *
 */
public abstract class CacheBackedClientContentSourceLnkPeer
    extends net.sf.iquiver.om.BaseClientContentSourceLnkPeer
{
	...
	static
	{
		logger = LogFactory.getLog(CacheBackedClientContentSourceLnkPeer.class);
		CACHE_KEY = "${targetDBOPackage}.torque.${databaseName}.om.ClientContentSourceLnk";
		useCache = false;
		clear_crit = new Criteria();

		if(CacheBackedPeer.isEnabledAtStartup())
		{
    		if(CacheBackedPeer.getExcludeEnableAtStartUp() != null && !ArrayUtil.containsMatchingRegExString(CacheBackedPeer.getExcludeEnableAtStartUp(), "de.dat.u3.db.dbo.torque.cd.om.ClientContentSourceLnkPeer"))
    		{
				enableCache(true);
        	    if(CacheBackedPeer.isEnableCacheForCriteriaSelects())
        	    {
    				...
    				{
    					enableCacheForCriteriaSelects(!ArrayUtil.containsMatchingRegExString(CacheBackedPeer.getExcludeEnableCacheForCriteriaSelects(), "de.dat.u3.db.dbo.torque.cd.om.ClientContentSourceLnkPeer"));
    				}
    				else
    				{
	...
	private static ClientContentSourceLnk getObjectFromCache(ClientContentSourceLnk obj)
	{		
		ClientContentSourceLnk tmpObj = null;		
	...
	private static ClientContentSourceLnk getObjectFromCache(ObjectKey key) throws IllegalArgumentException
	{
		ClientContentSourceLnk tmpObj = null;
		...
		if(isCacheEnabled())
		{
			if (key != null && key.getValue() != null)
			{
				try
				{
					tmpObj = (ClientContentSourceLnk)cache.get(key);
				}
				catch(NullPointerException ne)
				{
	...
	private static void addObjectToCache(ObjectKey key, ClientContentSourceLnk obj)
	{
	...
	private static void addCriteriaResultListToCache(Criteria criteria, List objects)
	{
		...
		{
			ClientContentSourceLnk obj = (ClientContentSourceLnk)it.next();
			ObjectKey key = obj.getPrimaryKey();
			idList.add(key);
    ...
    /**
	 * Completes a partially populated ClientContentSourceLnk object by fetching the missing values from the database.<br>
	 * If the complete ClientContentSourceLnk is already stored in the object cache, the cached object will be returned<br>
     * As the case may be this method will add the fetched object to the cache	 
     * @param obj A partially populated ClientContentSourceLnk. <code>obj</code> will not be changed, this method returns a new object instead.
     * @return a ClientContentSourceLnk object containing all values available in the database.
     * @throws TorqueException
     */	 
	public static ClientContentSourceLnk doSelectSingle(ClientContentSourceLnk obj) throws TorqueException
	{			
		ClientContentSourceLnk tmpObj = getObjectFromCache(obj);
		
		if(tmpObj == null)
		{
			List objList = net.sf.iquiver.om.BaseClientContentSourceLnkPeer.doSelect(obj);
			if(objList != null && !objList.isEmpty())
			{
				tmpObj = (ClientContentSourceLnk)objList.get(0);
				if(tmpObj != null)
				{
    ...
    /**
	 * Fetches a list of ClientContentSourceLnks by a partially populated ClientContentSourceLnk object from the database.<br>
     ...
     * @throws TorqueException
     */	 
	public static List doSelect(ClientContentSourceLnk obj) throws TorqueException
	{			
		return doSelect(buildCriteria(obj));
	}
		
    /**
     * Fetches a list of ClientContentSourceLnks from the database by a given criteria<br>
     ...
     * @param crit
     * @return a list of ClientContentSourceLnks fetched from the database or cache
     * @throws TorqueException
     */	
	...
	public static List doSelect(final Criteria crit, Connection con) throws TorqueException
	{
		...
		{
			results = net.sf.iquiver.om.BaseClientContentSourceLnkPeer.doSelect(crit, con);
    ...
    /**
     * Fetches all ClientContentSourceLnks from the database<br>
    ...
    /**
     * Fetches a ClientContentSourceLnk from the database by a given primary key<br>
	 * If the ClientContentSourceLnk is already stored in the object cache, the cached object will be returned<br>
     * As the case may be this method will add the fetched object to the cache	 
     * @param key The primary key of the desired ClientContentSourceLnk
     * @return a ClientContentSourceLnk fetched from the database or cache
     * @throws TorqueException
     */	
	public static ClientContentSourceLnk retrieveByPK(ObjectKey key) throws TorqueException
	{
		ClientContentSourceLnk obj = getObjectFromCache(key);
		
		if(obj == null)
		{
			obj = net.sf.iquiver.om.BaseClientContentSourceLnkPeer.retrieveByPK(key);
			addObjectToCache(key, obj);
		}
     ...
     * @throws TorqueException
     */	
	public static ClientContentSourceLnk retrieveByPK(ObjectKey key, Connection con) throws TorqueException
	{
		ClientContentSourceLnk obj = getObjectFromCache(key);
		
		if(obj == null)
		{
			obj = net.sf.iquiver.om.BaseClientContentSourceLnkPeer.retrieveByPK(key, con);
			addObjectToCache(key, obj);
		}
    ...
    /**
     * Fetches multiple ClientContentSourceLnks from the database by a given list of primary keys<br>
    ...
    public static List retrieveByPKs( List pks, Connection dbcon ) throws TorqueException
    {
	    ...
	    /**
     * Fetches a ClientContentSourceLnk by it's primary key members from database or cache<br>
     * As the case may be this method will add the fetched object to the cache
		 * @param clientid
     ...
     * @throws TorqueException
     */		    
	    public static ClientContentSourceLnk retrieveByPK(
   			int clientid	, 			long contentsourceid			) throws TorqueException
    {
        Connection db = null;
        ClientContentSourceLnk retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
           retVal = retrieveByPK(
     ...
     */		    
	    public static ClientContentSourceLnk retrieveByPK(
   			int clientid	, 			long contentsourceid		       ,Connection con) throws TorqueException
    {
		ClientContentSourceLnk obj = null;
		
					SimpleKey[] sKeys = new SimpleKey[]{
		   					SimpleKey.keyFor(clientid) , 							SimpleKey.keyFor(contentsourceid) 						};
    ...
    /**
     * Deletes an ClientContentSourceLnk in the database, if the ClientContentSourceLnk is already stored in the object cache,<br>
     * it will be removed
     * @param obj
     * @throws TorqueException
     */
	public static void doDelete(ClientContentSourceLnk obj) throws TorqueException
	{		
		net.sf.iquiver.om.BaseClientContentSourceLnkPeer.doDelete(obj);
     ...
     * @throws TorqueException
     */
	public static void doDelete(ClientContentSourceLnk obj, Connection con) throws TorqueException
	{
		net.sf.iquiver.om.BaseClientContentSourceLnkPeer.doDelete(obj, con);
		removeObjectFromCache(obj.getPrimaryKey());		
	}
	
    /**
     * Deletes one or more ClientContentSourceLnks in the database.<br>
     * If the CriteriaResultListCache is enabled and does contain an list of primary keys for the given criteria, the idList<br>
     * will get removed from the CriteriaResultListCache and also the corresponding ClientContentSourceLnks will be removed<br>
	...
	{
		net.sf.iquiver.om.BaseClientContentSourceLnkPeer.doDelete(crit);
    ...
    /**
     * Deletes one or more ClientContentSourceLnks in the database.
     * If the CriteriaResultListCache is enabled and does contain an list of primary keys for the given criteria, the idList<br>
     * will get removed from the CriteriaResultListCache and also the corresponding ClientContentSourceLnks will be removed<br>
	...
	{
		net.sf.iquiver.om.BaseClientContentSourceLnkPeer.doDelete(crit, con);
		if(isCacheEnabled() && isCacheForCriteriaSelectsEnabled())
		{
			removeCriteriaResultListFromCache(crit);
		}
    ...
    /**
     * Deletes an ClientContentSourceLnk in the database by a given primary key<br>
     * If the ClientContentSourceLnk is already stored in the object cache, it will be removed
     * @param key
     * @throws TorqueException
     */	
	public static void doDelete(ObjectKey key) throws TorqueException
	{
		net.sf.iquiver.om.BaseClientContentSourceLnkPeer.doDelete(key);		
		removeObjectFromCache(key);				
	}		

    /**
     * Deletes an ClientContentSourceLnk in the database by a given primary key<br>
     * If the ClientContentSourceLnk is already stored in the object cache, it will be removed<br>
     * This method uses a existing Transaction          
     * @param key
     * @throws TorqueException
     */	
	...
	{
		net.sf.iquiver.om.BaseClientContentSourceLnkPeer.doDelete(key, con);			
		removeObjectFromCache(key);
	}		
    ...
    /**
     * Inserts or updates an ClientContentSourceLnk obj in the database<br>
     ...
     * @throws TorqueException
     */
	public static void doInsert(ClientContentSourceLnk obj) throws TorqueException
	{		
		removeObjectFromCache(obj.getPrimaryKey());
		net.sf.iquiver.om.BaseClientContentSourceLnkPeer.doInsert(obj);
		if(obj != null)
		{
     ...
     * @throws TorqueException
     */
	public static void doInsert(ClientContentSourceLnk obj, Connection con) throws TorqueException
	{
		removeObjectFromCache(obj.getPrimaryKey());
		net.sf.iquiver.om.BaseClientContentSourceLnkPeer.doInsert(obj, con);
		if(obj != null)
		{
			addObjectToCache(obj.getPrimaryKey(), obj);		
		}
