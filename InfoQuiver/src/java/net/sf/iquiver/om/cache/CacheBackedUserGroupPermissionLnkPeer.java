...
import net.sf.iquiver.om.UserGroupPermissionLnk;
 ...
 *
 */
public abstract class CacheBackedUserGroupPermissionLnkPeer
    extends net.sf.iquiver.om.BaseUserGroupPermissionLnkPeer
{
	...
	static
	{
		logger = LogFactory.getLog(CacheBackedUserGroupPermissionLnkPeer.class);
		CACHE_KEY = "${targetDBOPackage}.torque.${databaseName}.om.UserGroupPermissionLnk";
		useCache = false;
		clear_crit = new Criteria();

		if(CacheBackedPeer.isEnabledAtStartup())
		{
    		if(CacheBackedPeer.getExcludeEnableAtStartUp() != null && !ArrayUtil.containsMatchingRegExString(CacheBackedPeer.getExcludeEnableAtStartUp(), "de.dat.u3.db.dbo.torque.cd.om.UserGroupPermissionLnkPeer"))
    		{
				enableCache(true);
        	    if(CacheBackedPeer.isEnableCacheForCriteriaSelects())
        	    {
    				...
    				{
    					enableCacheForCriteriaSelects(!ArrayUtil.containsMatchingRegExString(CacheBackedPeer.getExcludeEnableCacheForCriteriaSelects(), "de.dat.u3.db.dbo.torque.cd.om.UserGroupPermissionLnkPeer"));
    				}
    				else
    				{
	...
	private static UserGroupPermissionLnk getObjectFromCache(UserGroupPermissionLnk obj)
	{		
		UserGroupPermissionLnk tmpObj = null;		
	...
	private static UserGroupPermissionLnk getObjectFromCache(ObjectKey key) throws IllegalArgumentException
	{
		UserGroupPermissionLnk tmpObj = null;
		...
		if(isCacheEnabled())
		{
			if (key != null && key.getValue() != null)
			{
				try
				{
					tmpObj = (UserGroupPermissionLnk)cache.get(key);
				}
				catch(NullPointerException ne)
				{
	...
	private static void addObjectToCache(ObjectKey key, UserGroupPermissionLnk obj)
	{
	...
	private static void addCriteriaResultListToCache(Criteria criteria, List objects)
	{
		...
		{
			UserGroupPermissionLnk obj = (UserGroupPermissionLnk)it.next();
			ObjectKey key = obj.getPrimaryKey();
			idList.add(key);
    ...
    /**
	 * Completes a partially populated UserGroupPermissionLnk object by fetching the missing values from the database.<br>
	 * If the complete UserGroupPermissionLnk is already stored in the object cache, the cached object will be returned<br>
     * As the case may be this method will add the fetched object to the cache	 
     * @param obj A partially populated UserGroupPermissionLnk. <code>obj</code> will not be changed, this method returns a new object instead.
     * @return a UserGroupPermissionLnk object containing all values available in the database.
     * @throws TorqueException
     */	 
	public static UserGroupPermissionLnk doSelectSingle(UserGroupPermissionLnk obj) throws TorqueException
	{			
		UserGroupPermissionLnk tmpObj = getObjectFromCache(obj);
		
		if(tmpObj == null)
		{
			List objList = net.sf.iquiver.om.BaseUserGroupPermissionLnkPeer.doSelect(obj);
			if(objList != null && !objList.isEmpty())
			{
				tmpObj = (UserGroupPermissionLnk)objList.get(0);
				if(tmpObj != null)
				{
    ...
    /**
	 * Fetches a list of UserGroupPermissionLnks by a partially populated UserGroupPermissionLnk object from the database.<br>
     ...
     * @throws TorqueException
     */	 
	public static List doSelect(UserGroupPermissionLnk obj) throws TorqueException
	{			
		return doSelect(buildCriteria(obj));
	}
		
    /**
     * Fetches a list of UserGroupPermissionLnks from the database by a given criteria<br>
     ...
     * @param crit
     * @return a list of UserGroupPermissionLnks fetched from the database or cache
     * @throws TorqueException
     */	
	...
	public static List doSelect(final Criteria crit, Connection con) throws TorqueException
	{
		...
		{
			results = net.sf.iquiver.om.BaseUserGroupPermissionLnkPeer.doSelect(crit, con);
    ...
    /**
     * Fetches all UserGroupPermissionLnks from the database<br>
    ...
    /**
     * Fetches a UserGroupPermissionLnk from the database by a given primary key<br>
	 * If the UserGroupPermissionLnk is already stored in the object cache, the cached object will be returned<br>
     * As the case may be this method will add the fetched object to the cache	 
     * @param key The primary key of the desired UserGroupPermissionLnk
     * @return a UserGroupPermissionLnk fetched from the database or cache
     * @throws TorqueException
     */	
	public static UserGroupPermissionLnk retrieveByPK(ObjectKey key) throws TorqueException
	{
		UserGroupPermissionLnk obj = getObjectFromCache(key);
		
		if(obj == null)
		{
			obj = net.sf.iquiver.om.BaseUserGroupPermissionLnkPeer.retrieveByPK(key);
			addObjectToCache(key, obj);
		}
     ...
     * @throws TorqueException
     */	
	public static UserGroupPermissionLnk retrieveByPK(ObjectKey key, Connection con) throws TorqueException
	{
		UserGroupPermissionLnk obj = getObjectFromCache(key);
		
		if(obj == null)
		{
			obj = net.sf.iquiver.om.BaseUserGroupPermissionLnkPeer.retrieveByPK(key, con);
			addObjectToCache(key, obj);
		}
    ...
    /**
     * Fetches multiple UserGroupPermissionLnks from the database by a given list of primary keys<br>
    ...
    public static List retrieveByPKs( List pks, Connection dbcon ) throws TorqueException
    {
	    ...
	    /**
     * Fetches a UserGroupPermissionLnk by it's primary key members from database or cache<br>
     * As the case may be this method will add the fetched object to the cache
		 * @param usergroupid
			 * @param permissionid
     ...
     * @throws TorqueException
     */		    
	    public static UserGroupPermissionLnk retrieveByPK(
   			long usergroupid	, 			int permissionid			) throws TorqueException
    {
        Connection db = null;
        UserGroupPermissionLnk retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
           retVal = retrieveByPK(
     ...
     */		    
	    public static UserGroupPermissionLnk retrieveByPK(
   			long usergroupid	, 			int permissionid		       ,Connection con) throws TorqueException
    {
		UserGroupPermissionLnk obj = null;
		
					SimpleKey[] sKeys = new SimpleKey[]{
		   					SimpleKey.keyFor(usergroupid) , 							SimpleKey.keyFor(permissionid) 						};
    ...
    /**
     * Deletes an UserGroupPermissionLnk in the database, if the UserGroupPermissionLnk is already stored in the object cache,<br>
     * it will be removed
     * @param obj
     * @throws TorqueException
     */
	public static void doDelete(UserGroupPermissionLnk obj) throws TorqueException
	{		
		net.sf.iquiver.om.BaseUserGroupPermissionLnkPeer.doDelete(obj);
     ...
     * @throws TorqueException
     */
	public static void doDelete(UserGroupPermissionLnk obj, Connection con) throws TorqueException
	{
		net.sf.iquiver.om.BaseUserGroupPermissionLnkPeer.doDelete(obj, con);
		removeObjectFromCache(obj.getPrimaryKey());		
	}
	
    /**
     * Deletes one or more UserGroupPermissionLnks in the database.<br>
     * If the CriteriaResultListCache is enabled and does contain an list of primary keys for the given criteria, the idList<br>
     * will get removed from the CriteriaResultListCache and also the corresponding UserGroupPermissionLnks will be removed<br>
	...
	{
		net.sf.iquiver.om.BaseUserGroupPermissionLnkPeer.doDelete(crit);
    ...
    /**
     * Deletes one or more UserGroupPermissionLnks in the database.
     * If the CriteriaResultListCache is enabled and does contain an list of primary keys for the given criteria, the idList<br>
     * will get removed from the CriteriaResultListCache and also the corresponding UserGroupPermissionLnks will be removed<br>
	...
	{
		net.sf.iquiver.om.BaseUserGroupPermissionLnkPeer.doDelete(crit, con);
		if(isCacheEnabled() && isCacheForCriteriaSelectsEnabled())
		{
			removeCriteriaResultListFromCache(crit);
		}
    ...
    /**
     * Deletes an UserGroupPermissionLnk in the database by a given primary key<br>
     * If the UserGroupPermissionLnk is already stored in the object cache, it will be removed
     * @param key
     * @throws TorqueException
     */	
	public static void doDelete(ObjectKey key) throws TorqueException
	{
		net.sf.iquiver.om.BaseUserGroupPermissionLnkPeer.doDelete(key);		
		removeObjectFromCache(key);				
	}		

    /**
     * Deletes an UserGroupPermissionLnk in the database by a given primary key<br>
     * If the UserGroupPermissionLnk is already stored in the object cache, it will be removed<br>
     * This method uses a existing Transaction          
     * @param key
     * @throws TorqueException
     */	
	...
	{
		net.sf.iquiver.om.BaseUserGroupPermissionLnkPeer.doDelete(key, con);			
		removeObjectFromCache(key);
	}		
    ...
    /**
     * Inserts or updates an UserGroupPermissionLnk obj in the database<br>
     ...
     * @throws TorqueException
     */
	public static void doInsert(UserGroupPermissionLnk obj) throws TorqueException
	{		
		removeObjectFromCache(obj.getPrimaryKey());
		net.sf.iquiver.om.BaseUserGroupPermissionLnkPeer.doInsert(obj);
		if(obj != null)
		{
     ...
     * @throws TorqueException
     */
	public static void doInsert(UserGroupPermissionLnk obj, Connection con) throws TorqueException
	{
		removeObjectFromCache(obj.getPrimaryKey());
		net.sf.iquiver.om.BaseUserGroupPermissionLnkPeer.doInsert(obj, con);
		if(obj != null)
		{
			addObjectToCache(obj.getPrimaryKey(), obj);		
		}
