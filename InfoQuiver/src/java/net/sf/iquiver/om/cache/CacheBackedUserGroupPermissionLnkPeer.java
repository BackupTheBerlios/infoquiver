...
{
	final private static Log logger = LogFactory.getLog(CacheBackedUserGroupPermissionLnkPeer.class);
	
	final public static String CACHE_KEY = "net.sf.iquiver.om.UserGroupPermissionLnk";
