 ...
 *
 */
public abstract class CacheBackedUserPeer
    extends net.sf.iquiver.om.BaseUserPeer
{
	...
	static
	{
		logger = LogFactory.getLog(CacheBackedUserPeer.class);
		CACHE_KEY = "${targetDBOPackage}.torque.${databaseName}.om.User";
		useCache = false;
		clear_crit = new Criteria();

		if(CacheBackedPeer.isEnabledAtStartup())
		{
    		if(CacheBackedPeer.getExcludeEnableAtStartUp() != null && !ArrayUtil.containsMatchingRegExString(CacheBackedPeer.getExcludeEnableAtStartUp(), "de.dat.u3.db.dbo.torque.cd.om.UserPeer"))
    		{
				enableCache(true);
        	    if(CacheBackedPeer.isEnableCacheForCriteriaSelects())
        	    {
    				...
    				{
    					enableCacheForCriteriaSelects(!ArrayUtil.containsMatchingRegExString(CacheBackedPeer.getExcludeEnableCacheForCriteriaSelects(), "de.dat.u3.db.dbo.torque.cd.om.UserPeer"));
    				}
    				else
    				{
	...
	private static User getObjectFromCache(User obj)
	{		
		User tmpObj = null;		
	...
	private static User getObjectFromCache(ObjectKey key) throws IllegalArgumentException
	{
		User tmpObj = null;
	...
	private static void addObjectToCache(ObjectKey key, User obj)
	{
    ...
    /**
	 * Completes a partially populated User object by fetching the missing values from the database.<br>
	 * If the complete User is already stored in the object cache, the cached object will be returned<br>
     * As the case may be this method will add the fetched object to the cache	 
     * @param obj A partially populated User. <code>obj</code> will not be changed, this method returns a new object instead.
     * @return a User object containing all values available in the database.
     * @throws TorqueException
     */	 
	public static User doSelectSingle(User obj) throws TorqueException
	{			
		User tmpObj = getObjectFromCache(obj);
		
		if(tmpObj == null)
		{
			List objList = net.sf.iquiver.om.BaseUserPeer.doSelect(obj);
			if(objList != null && !objList.isEmpty())
			{
				tmpObj = (User)objList.get(0);
				if(tmpObj != null)
				{
    ...
    /**
	 * Fetches a list of Users by a partially populated User object from the database.<br>
    ...
    /**
     * Fetches a list of Users from the database by a given criteria<br>
     ...
     * @param crit
     * @return a list of Users fetched from the database or cache
     * @throws TorqueException
     */	
	...
	public static List doSelect(final Criteria crit, Connection con) throws TorqueException
	{
		...
		{
			results = net.sf.iquiver.om.BaseUserPeer.doSelect(crit, con);
    ...
    /**
     * Fetches all Users from the database<br>
     ...
     */
    public static User retrieveByPK(long pk) throws TorqueException
    {
        return retrieveByPK(SimpleKey.keyFor(pk));
    }
  
    /**
     * Fetches a User from the database by a given primary key<br>
	 * If the User is already stored in the object cache, the cached object will be returned<br>
     * As the case may be this method will add the fetched object to the cache	 
     * @param key The primary key of the desired User
     * @return a User fetched from the database or cache
     * @throws TorqueException
     */	
	public static User retrieveByPK(ObjectKey key) throws TorqueException
	{
		User obj = getObjectFromCache(key);
		
		if(obj == null)
		{
			obj = net.sf.iquiver.om.BaseUserPeer.retrieveByPK(key);
			addObjectToCache(key, obj);
		}
     ...
     * @throws TorqueException
     */	
	public static User retrieveByPK(ObjectKey key, Connection con) throws TorqueException
	{
		User obj = getObjectFromCache(key);
		
		if(obj == null)
		{
			obj = net.sf.iquiver.om.BaseUserPeer.retrieveByPK(key, con);
			addObjectToCache(key, obj);
		}
    ...
    /**
     * Fetches multiple Users from the database by a given list of primary keys<br>
    ...
    /**
     * Deletes an User in the database, if the User is already stored in the object cache,<br>
     * it will be removed
     * @param obj
     * @throws TorqueException
     */
	...
	{		
		net.sf.iquiver.om.BaseUserPeer.doDelete(obj);
     ...
     * @throws TorqueException
     */
	public static void doDelete(User obj, Connection con) throws TorqueException
	{
		net.sf.iquiver.om.BaseUserPeer.doDelete(obj, con);
		removeObjectFromCache(obj.getPrimaryKey());		
	}
	
    /**
     * Deletes one or more Users in the database.<br>
     * If the CriteriaResultListCache is enabled and does contain an list of primary keys for the given criteria, the idList<br>
     * will get removed from the CriteriaResultListCache and also the corresponding Users will be removed<br>
	...
	{
		net.sf.iquiver.om.BaseUserPeer.doDelete(crit);
    ...
    /**
     * Deletes one or more Users in the database.
     * If the CriteriaResultListCache is enabled and does contain an list of primary keys for the given criteria, the idList<br>
     * will get removed from the CriteriaResultListCache and also the corresponding Users will be removed<br>
	...
	{
		net.sf.iquiver.om.BaseUserPeer.doDelete(crit, con);
		if(isCacheEnabled() && isCacheForCriteriaSelectsEnabled())
		{
			removeCriteriaResultListFromCache(crit);
		}
    ...
    /**
     * Deletes an User in the database by a given primary key<br>
     * If the User is already stored in the object cache, it will be removed
     * @param key
     * @throws TorqueException
     */	
	public static void doDelete(ObjectKey key) throws TorqueException
	{
		net.sf.iquiver.om.BaseUserPeer.doDelete(key);		
		removeObjectFromCache(key);				
	}		

    /**
     * Deletes an User in the database by a given primary key<br>
     * If the User is already stored in the object cache, it will be removed<br>
     * This method uses a existing Transaction          
     * @param key
     * @throws TorqueException
     */	
	...
	{
		net.sf.iquiver.om.BaseUserPeer.doDelete(key, con);			
		removeObjectFromCache(key);
	}		
     ...
     */		    
	    public static void doDelete(
   			long userid		    ) throws TorqueException
    {
		...
		if(isCacheEnabled() && isCacheForCriteriaSelectsEnabled())
		{		
							SimpleKey oKey = SimpleKey.keyFor(userid);
     ...
     */		    
	    public static void doDelete(
   			long userid				, Connection con) throws TorqueException
	{
		Criteria crit = new Criteria();
	   				crit.add(USER_ID, userid);
				net.sf.iquiver.om.BaseUserPeer.doDelete(crit, con);
    ...
    /**
     * Inserts or updates an User obj in the database<br>
	...
	{		
		removeObjectFromCache(obj.getPrimaryKey());
		net.sf.iquiver.om.BaseUserPeer.doInsert(obj);
		if(obj != null)
		{
     ...
     * @throws TorqueException
     */
	public static void doInsert(User obj, Connection con) throws TorqueException
	{
		removeObjectFromCache(obj.getPrimaryKey());
		net.sf.iquiver.om.BaseUserPeer.doInsert(obj, con);
		if(obj != null)
		{
			addObjectToCache(obj.getPrimaryKey(), obj);		
		}
