...
import net.sf.iquiver.om.Permission;
 ...
 *
 */
public abstract class CacheBackedPermissionPeer
    extends net.sf.iquiver.om.BasePermissionPeer
{
	...
	static
	{
		logger = LogFactory.getLog(CacheBackedPermissionPeer.class);
		CACHE_KEY = "${targetDBOPackage}.torque.${databaseName}.om.Permission";
		useCache = false;
		clear_crit = new Criteria();

		if(CacheBackedPeer.isEnabledAtStartup())
		{
    		if(CacheBackedPeer.getExcludeEnableAtStartUp() != null && !ArrayUtil.containsMatchingRegExString(CacheBackedPeer.getExcludeEnableAtStartUp(), "de.dat.u3.db.dbo.torque.cd.om.PermissionPeer"))
    		{
				enableCache(true);
        	    if(CacheBackedPeer.isEnableCacheForCriteriaSelects())
        	    {
    				...
    				{
    					enableCacheForCriteriaSelects(!ArrayUtil.containsMatchingRegExString(CacheBackedPeer.getExcludeEnableCacheForCriteriaSelects(), "de.dat.u3.db.dbo.torque.cd.om.PermissionPeer"));
    				}
    				else
    				{
	...
	private static Permission getObjectFromCache(Permission obj)
	{		
		Permission tmpObj = null;		
	...
	private static Permission getObjectFromCache(ObjectKey key) throws IllegalArgumentException
	{
		Permission tmpObj = null;
		...
		if(isCacheEnabled())
		{
			if (key != null && key.getValue() != null)
			{
				try
				{
					tmpObj = (Permission)cache.get(key);
				}
				catch(NullPointerException ne)
				{
	...
	private static void addObjectToCache(ObjectKey key, Permission obj)
	{
	...
	private static void addCriteriaResultListToCache(Criteria criteria, List objects)
	{
		...
		{
			Permission obj = (Permission)it.next();
			ObjectKey key = obj.getPrimaryKey();
			idList.add(key);
    ...
    /**
	 * Completes a partially populated Permission object by fetching the missing values from the database.<br>
	 * If the complete Permission is already stored in the object cache, the cached object will be returned<br>
     * As the case may be this method will add the fetched object to the cache	 
     * @param obj A partially populated Permission. <code>obj</code> will not be changed, this method returns a new object instead.
     * @return a Permission object containing all values available in the database.
     * @throws TorqueException
     */	 
	public static Permission doSelectSingle(Permission obj) throws TorqueException
	{			
		Permission tmpObj = getObjectFromCache(obj);
		
		if(tmpObj == null)
		{
			List objList = net.sf.iquiver.om.BasePermissionPeer.doSelect(obj);
			if(objList != null && !objList.isEmpty())
			{
				tmpObj = (Permission)objList.get(0);
				if(tmpObj != null)
				{
    ...
    /**
	 * Fetches a list of Permissions by a partially populated Permission object from the database.<br>
     ...
     * @throws TorqueException
     */	 
	public static List doSelect(Permission obj) throws TorqueException
	{			
		return doSelect(buildCriteria(obj));
	}
		
    /**
     * Fetches a list of Permissions from the database by a given criteria<br>
     ...
     * @param crit
     * @return a list of Permissions fetched from the database or cache
     * @throws TorqueException
     */	
	...
	public static List doSelect(final Criteria crit, Connection con) throws TorqueException
	{
		...
		{
			results = net.sf.iquiver.om.BasePermissionPeer.doSelect(crit, con);
    ...
    /**
     * Fetches all Permissions from the database<br>
     ...
     */
    public static Permission retrieveByPK(int pk) throws TorqueException
    {
        return retrieveByPK(SimpleKey.keyFor(pk));
    }
  
    /**
     * Fetches a Permission from the database by a given primary key<br>
	 * If the Permission is already stored in the object cache, the cached object will be returned<br>
     * As the case may be this method will add the fetched object to the cache	 
     * @param key The primary key of the desired Permission
     * @return a Permission fetched from the database or cache
     * @throws TorqueException
     */	
	public static Permission retrieveByPK(ObjectKey key) throws TorqueException
	{
		Permission obj = getObjectFromCache(key);
		
		if(obj == null)
		{
			obj = net.sf.iquiver.om.BasePermissionPeer.retrieveByPK(key);
			addObjectToCache(key, obj);
		}
     ...
     * @throws TorqueException
     */	
	public static Permission retrieveByPK(ObjectKey key, Connection con) throws TorqueException
	{
		Permission obj = getObjectFromCache(key);
		
		if(obj == null)
		{
			obj = net.sf.iquiver.om.BasePermissionPeer.retrieveByPK(key, con);
			addObjectToCache(key, obj);
		}
    ...
    /**
     * Fetches multiple Permissions from the database by a given list of primary keys<br>
    ...
    /**
     * Deletes an Permission in the database, if the Permission is already stored in the object cache,<br>
     * it will be removed
     * @param obj
     * @throws TorqueException
     */
	public static void doDelete(Permission obj) throws TorqueException
	{		
		net.sf.iquiver.om.BasePermissionPeer.doDelete(obj);
     ...
     * @throws TorqueException
     */
	public static void doDelete(Permission obj, Connection con) throws TorqueException
	{
		net.sf.iquiver.om.BasePermissionPeer.doDelete(obj, con);
		removeObjectFromCache(obj.getPrimaryKey());		
	}
	
    /**
     * Deletes one or more Permissions in the database.<br>
     * If the CriteriaResultListCache is enabled and does contain an list of primary keys for the given criteria, the idList<br>
     * will get removed from the CriteriaResultListCache and also the corresponding Permissions will be removed<br>
	...
	{
		net.sf.iquiver.om.BasePermissionPeer.doDelete(crit);
    ...
    /**
     * Deletes one or more Permissions in the database.
     * If the CriteriaResultListCache is enabled and does contain an list of primary keys for the given criteria, the idList<br>
     * will get removed from the CriteriaResultListCache and also the corresponding Permissions will be removed<br>
	...
	{
		net.sf.iquiver.om.BasePermissionPeer.doDelete(crit, con);
		if(isCacheEnabled() && isCacheForCriteriaSelectsEnabled())
		{
			removeCriteriaResultListFromCache(crit);
		}
    ...
    /**
     * Deletes an Permission in the database by a given primary key<br>
     * If the Permission is already stored in the object cache, it will be removed
     * @param key
     * @throws TorqueException
     */	
	public static void doDelete(ObjectKey key) throws TorqueException
	{
		net.sf.iquiver.om.BasePermissionPeer.doDelete(key);		
		removeObjectFromCache(key);				
	}		

    /**
     * Deletes an Permission in the database by a given primary key<br>
     * If the Permission is already stored in the object cache, it will be removed<br>
     * This method uses a existing Transaction          
     * @param key
     * @throws TorqueException
     */	
	...
	{
		net.sf.iquiver.om.BasePermissionPeer.doDelete(key, con);			
		removeObjectFromCache(key);
	}		
     ...
     */		    
	    public static void doDelete(
   			int permissionid		    ) throws TorqueException
    {
		...
		if(isCacheEnabled() && isCacheForCriteriaSelectsEnabled())
		{		
							SimpleKey oKey = SimpleKey.keyFor(permissionid);
     ...
     */		    
	    public static void doDelete(
   			int permissionid				, Connection con) throws TorqueException
	{
		Criteria crit = new Criteria();
	   				crit.add(PERMISSION_ID, permissionid);
				net.sf.iquiver.om.BasePermissionPeer.doDelete(crit, con);
    ...
    /**
     * Inserts or updates an Permission obj in the database<br>
     ...
     * @throws TorqueException
     */
	public static void doInsert(Permission obj) throws TorqueException
	{		
		removeObjectFromCache(obj.getPrimaryKey());
		net.sf.iquiver.om.BasePermissionPeer.doInsert(obj);
		if(obj != null)
		{
     ...
     * @throws TorqueException
     */
	public static void doInsert(Permission obj, Connection con) throws TorqueException
	{
		removeObjectFromCache(obj.getPrimaryKey());
		net.sf.iquiver.om.BasePermissionPeer.doInsert(obj, con);
		if(obj != null)
		{
			addObjectToCache(obj.getPrimaryKey(), obj);		
		}
