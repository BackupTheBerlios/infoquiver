 ...
 *
 */
public abstract class CacheBackedContentPeer
    extends net.sf.iquiver.om.BaseContentPeer
{
	...
	static
	{
		logger = LogFactory.getLog(CacheBackedContentPeer.class);
		CACHE_KEY = "${targetDBOPackage}.torque.${databaseName}.om.Content";
		useCache = false;
		clear_crit = new Criteria();

		if(CacheBackedPeer.isEnabledAtStartup())
		{
    		if(CacheBackedPeer.getExcludeEnableAtStartUp() != null && !ArrayUtil.containsMatchingRegExString(CacheBackedPeer.getExcludeEnableAtStartUp(), "de.dat.u3.db.dbo.torque.cd.om.ContentPeer"))
    		{
				enableCache(true);
        	    if(CacheBackedPeer.isEnableCacheForCriteriaSelects())
        	    {
    				...
    				{
    					enableCacheForCriteriaSelects(!ArrayUtil.containsMatchingRegExString(CacheBackedPeer.getExcludeEnableCacheForCriteriaSelects(), "de.dat.u3.db.dbo.torque.cd.om.ContentPeer"));
    				}
    				else
    				{
	...
	private static Content getObjectFromCache(Content obj)
	{		
		Content tmpObj = null;		
	...
	private static Content getObjectFromCache(ObjectKey key) throws IllegalArgumentException
	{
		Content tmpObj = null;
	...
	private static void addObjectToCache(ObjectKey key, Content obj)
	{
    ...
    /**
	 * Completes a partially populated Content object by fetching the missing values from the database.<br>
	 * If the complete Content is already stored in the object cache, the cached object will be returned<br>
     * As the case may be this method will add the fetched object to the cache	 
     * @param obj A partially populated Content. <code>obj</code> will not be changed, this method returns a new object instead.
     * @return a Content object containing all values available in the database.
     * @throws TorqueException
     */	 
	public static Content doSelectSingle(Content obj) throws TorqueException
	{			
		Content tmpObj = getObjectFromCache(obj);
		
		if(tmpObj == null)
		{
			List objList = net.sf.iquiver.om.BaseContentPeer.doSelect(obj);
			if(objList != null && !objList.isEmpty())
			{
				tmpObj = (Content)objList.get(0);
				if(tmpObj != null)
				{
    ...
    /**
	 * Fetches a list of Contents by a partially populated Content object from the database.<br>
    ...
    /**
     * Fetches a list of Contents from the database by a given criteria<br>
     ...
     * @param crit
     * @return a list of Contents fetched from the database or cache
     * @throws TorqueException
     */	
	...
	public static List doSelect(final Criteria crit, Connection con) throws TorqueException
	{
		...
		{
			results = net.sf.iquiver.om.BaseContentPeer.doSelect(crit, con);
    ...
    /**
     * Fetches all Contents from the database<br>
     ...
     */
    public static Content retrieveByPK(long pk) throws TorqueException
    {
        return retrieveByPK(SimpleKey.keyFor(pk));
    }
  
    /**
     * Fetches a Content from the database by a given primary key<br>
	 * If the Content is already stored in the object cache, the cached object will be returned<br>
     * As the case may be this method will add the fetched object to the cache	 
     * @param key The primary key of the desired Content
     * @return a Content fetched from the database or cache
     * @throws TorqueException
     */	
	public static Content retrieveByPK(ObjectKey key) throws TorqueException
	{
		Content obj = getObjectFromCache(key);
		
		if(obj == null)
		{
			obj = net.sf.iquiver.om.BaseContentPeer.retrieveByPK(key);
			addObjectToCache(key, obj);
		}
     ...
     * @throws TorqueException
     */	
	public static Content retrieveByPK(ObjectKey key, Connection con) throws TorqueException
	{
		Content obj = getObjectFromCache(key);
		
		if(obj == null)
		{
			obj = net.sf.iquiver.om.BaseContentPeer.retrieveByPK(key, con);
			addObjectToCache(key, obj);
		}
    ...
    /**
     * Fetches multiple Contents from the database by a given list of primary keys<br>
    ...
    /**
     * Deletes an Content in the database, if the Content is already stored in the object cache,<br>
     * it will be removed
     * @param obj
     * @throws TorqueException
     */
	...
	{		
		net.sf.iquiver.om.BaseContentPeer.doDelete(obj);
     ...
     * @throws TorqueException
     */
	public static void doDelete(Content obj, Connection con) throws TorqueException
	{
		net.sf.iquiver.om.BaseContentPeer.doDelete(obj, con);
		removeObjectFromCache(obj.getPrimaryKey());		
	}
	
    /**
     * Deletes one or more Contents in the database.<br>
     * If the CriteriaResultListCache is enabled and does contain an list of primary keys for the given criteria, the idList<br>
     * will get removed from the CriteriaResultListCache and also the corresponding Contents will be removed<br>
	...
	{
		net.sf.iquiver.om.BaseContentPeer.doDelete(crit);
    ...
    /**
     * Deletes one or more Contents in the database.
     * If the CriteriaResultListCache is enabled and does contain an list of primary keys for the given criteria, the idList<br>
     * will get removed from the CriteriaResultListCache and also the corresponding Contents will be removed<br>
	...
	{
		net.sf.iquiver.om.BaseContentPeer.doDelete(crit, con);
		if(isCacheEnabled() && isCacheForCriteriaSelectsEnabled())
		{
			removeCriteriaResultListFromCache(crit);
		}
    ...
    /**
     * Deletes an Content in the database by a given primary key<br>
     * If the Content is already stored in the object cache, it will be removed
     * @param key
     * @throws TorqueException
     */	
	public static void doDelete(ObjectKey key) throws TorqueException
	{
		net.sf.iquiver.om.BaseContentPeer.doDelete(key);		
		removeObjectFromCache(key);				
	}		

    /**
     * Deletes an Content in the database by a given primary key<br>
     * If the Content is already stored in the object cache, it will be removed<br>
     * This method uses a existing Transaction          
     * @param key
     * @throws TorqueException
     */	
	...
	{
		net.sf.iquiver.om.BaseContentPeer.doDelete(key, con);			
		removeObjectFromCache(key);
	}		
     ...
     */		    
	    public static void doDelete(
   			long contentid		    ) throws TorqueException
    {
		...
		if(isCacheEnabled() && isCacheForCriteriaSelectsEnabled())
		{		
							SimpleKey oKey = SimpleKey.keyFor(contentid);
     ...
     */		    
	    public static void doDelete(
   			long contentid				, Connection con) throws TorqueException
	{
		Criteria crit = new Criteria();
	   				crit.add(CONTENT_ID, contentid);
				net.sf.iquiver.om.BaseContentPeer.doDelete(crit, con);
    ...
    /**
     * Inserts or updates an Content obj in the database<br>
	...
	{		
		removeObjectFromCache(obj.getPrimaryKey());
		net.sf.iquiver.om.BaseContentPeer.doInsert(obj);
		if(obj != null)
		{
     ...
     * @throws TorqueException
     */
	public static void doInsert(Content obj, Connection con) throws TorqueException
	{
		removeObjectFromCache(obj.getPrimaryKey());
		net.sf.iquiver.om.BaseContentPeer.doInsert(obj, con);
		if(obj != null)
		{
			addObjectToCache(obj.getPrimaryKey(), obj);		
		}
