...
import net.sf.iquiver.om.ContentSourceType;
 ...
 *
 */
public abstract class CacheBackedContentSourceTypePeer
    extends net.sf.iquiver.om.BaseContentSourceTypePeer
{
	...
	static
	{
		logger = LogFactory.getLog(CacheBackedContentSourceTypePeer.class);
		CACHE_KEY = "${targetDBOPackage}.torque.${databaseName}.om.ContentSourceType";
		useCache = false;
		clear_crit = new Criteria();

		if(CacheBackedPeer.isEnabledAtStartup())
		{
    		if(CacheBackedPeer.getExcludeEnableAtStartUp() != null && !ArrayUtil.containsMatchingRegExString(CacheBackedPeer.getExcludeEnableAtStartUp(), "de.dat.u3.db.dbo.torque.cd.om.ContentSourceTypePeer"))
    		{
				enableCache(true);
        	    if(CacheBackedPeer.isEnableCacheForCriteriaSelects())
        	    {
    				...
    				{
    					enableCacheForCriteriaSelects(!ArrayUtil.containsMatchingRegExString(CacheBackedPeer.getExcludeEnableCacheForCriteriaSelects(), "de.dat.u3.db.dbo.torque.cd.om.ContentSourceTypePeer"));
    				}
    				else
    				{
	...
	private static ContentSourceType getObjectFromCache(ContentSourceType obj)
	{		
		ContentSourceType tmpObj = null;		
	...
	private static ContentSourceType getObjectFromCache(ObjectKey key) throws IllegalArgumentException
	{
		ContentSourceType tmpObj = null;
		...
		if(isCacheEnabled())
		{
			if (key != null && key.getValue() != null)
			{
				try
				{
					tmpObj = (ContentSourceType)cache.get(key);
				}
				catch(NullPointerException ne)
				{
	...
	private static void addObjectToCache(ObjectKey key, ContentSourceType obj)
	{
	...
	private static void addCriteriaResultListToCache(Criteria criteria, List objects)
	{
		...
		{
			ContentSourceType obj = (ContentSourceType)it.next();
			ObjectKey key = obj.getPrimaryKey();
			idList.add(key);
    ...
    /**
	 * Completes a partially populated ContentSourceType object by fetching the missing values from the database.<br>
	 * If the complete ContentSourceType is already stored in the object cache, the cached object will be returned<br>
     * As the case may be this method will add the fetched object to the cache	 
     * @param obj A partially populated ContentSourceType. <code>obj</code> will not be changed, this method returns a new object instead.
     * @return a ContentSourceType object containing all values available in the database.
     * @throws TorqueException
     */	 
	public static ContentSourceType doSelectSingle(ContentSourceType obj) throws TorqueException
	{			
		ContentSourceType tmpObj = getObjectFromCache(obj);
		
		if(tmpObj == null)
		{
			List objList = net.sf.iquiver.om.BaseContentSourceTypePeer.doSelect(obj);
			if(objList != null && !objList.isEmpty())
			{
				tmpObj = (ContentSourceType)objList.get(0);
				if(tmpObj != null)
				{
    ...
    /**
	 * Fetches a list of ContentSourceTypes by a partially populated ContentSourceType object from the database.<br>
     ...
     * @throws TorqueException
     */	 
	public static List doSelect(ContentSourceType obj) throws TorqueException
	{			
		return doSelect(buildCriteria(obj));
	}
		
    /**
     * Fetches a list of ContentSourceTypes from the database by a given criteria<br>
     ...
     * @param crit
     * @return a list of ContentSourceTypes fetched from the database or cache
     * @throws TorqueException
     */	
	...
	public static List doSelect(final Criteria crit, Connection con) throws TorqueException
	{
		...
		{
			results = net.sf.iquiver.om.BaseContentSourceTypePeer.doSelect(crit, con);
    ...
    /**
     * Fetches all ContentSourceTypes from the database<br>
     ...
     */
    public static ContentSourceType retrieveByPK(int pk) throws TorqueException
    {
        return retrieveByPK(SimpleKey.keyFor(pk));
    }
  
    /**
     * Fetches a ContentSourceType from the database by a given primary key<br>
	 * If the ContentSourceType is already stored in the object cache, the cached object will be returned<br>
     * As the case may be this method will add the fetched object to the cache	 
     * @param key The primary key of the desired ContentSourceType
     * @return a ContentSourceType fetched from the database or cache
     * @throws TorqueException
     */	
	public static ContentSourceType retrieveByPK(ObjectKey key) throws TorqueException
	{
		ContentSourceType obj = getObjectFromCache(key);
		
		if(obj == null)
		{
			obj = net.sf.iquiver.om.BaseContentSourceTypePeer.retrieveByPK(key);
			addObjectToCache(key, obj);
		}
     ...
     * @throws TorqueException
     */	
	public static ContentSourceType retrieveByPK(ObjectKey key, Connection con) throws TorqueException
	{
		ContentSourceType obj = getObjectFromCache(key);
		
		if(obj == null)
		{
			obj = net.sf.iquiver.om.BaseContentSourceTypePeer.retrieveByPK(key, con);
			addObjectToCache(key, obj);
		}
    ...
    /**
     * Fetches multiple ContentSourceTypes from the database by a given list of primary keys<br>
    ...
    public static List retrieveByPKs( List pks, Connection dbcon ) throws TorqueException
    {
        ...
        else
        {
            Criteria criteria = new Criteria();
              criteria.addIn( CONTENT_SOURCE_TYPE_ID, pks );
    ...
    /**
     * Deletes an ContentSourceType in the database, if the ContentSourceType is already stored in the object cache,<br>
     * it will be removed
     * @param obj
     * @throws TorqueException
     */
	public static void doDelete(ContentSourceType obj) throws TorqueException
	{		
		net.sf.iquiver.om.BaseContentSourceTypePeer.doDelete(obj);
     ...
     * @throws TorqueException
     */
	public static void doDelete(ContentSourceType obj, Connection con) throws TorqueException
	{
		net.sf.iquiver.om.BaseContentSourceTypePeer.doDelete(obj, con);
		removeObjectFromCache(obj.getPrimaryKey());		
	}
	
    /**
     * Deletes one or more ContentSourceTypes in the database.<br>
     * If the CriteriaResultListCache is enabled and does contain an list of primary keys for the given criteria, the idList<br>
     * will get removed from the CriteriaResultListCache and also the corresponding ContentSourceTypes will be removed<br>
	...
	{
		net.sf.iquiver.om.BaseContentSourceTypePeer.doDelete(crit);
    ...
    /**
     * Deletes one or more ContentSourceTypes in the database.
     * If the CriteriaResultListCache is enabled and does contain an list of primary keys for the given criteria, the idList<br>
     * will get removed from the CriteriaResultListCache and also the corresponding ContentSourceTypes will be removed<br>
	...
	{
		net.sf.iquiver.om.BaseContentSourceTypePeer.doDelete(crit, con);
		if(isCacheEnabled() && isCacheForCriteriaSelectsEnabled())
		{
			removeCriteriaResultListFromCache(crit);
		}
    ...
    /**
     * Deletes an ContentSourceType in the database by a given primary key<br>
     * If the ContentSourceType is already stored in the object cache, it will be removed
     * @param key
     * @throws TorqueException
     */	
	public static void doDelete(ObjectKey key) throws TorqueException
	{
		net.sf.iquiver.om.BaseContentSourceTypePeer.doDelete(key);		
		removeObjectFromCache(key);				
	}		

    /**
     * Deletes an ContentSourceType in the database by a given primary key<br>
     * If the ContentSourceType is already stored in the object cache, it will be removed<br>
     * This method uses a existing Transaction          
     * @param key
     * @throws TorqueException
     */	
	...
	{
		net.sf.iquiver.om.BaseContentSourceTypePeer.doDelete(key, con);			
		removeObjectFromCache(key);
	}		
     ...
     */		    
	    public static void doDelete(
   			int contentsourcetypeid		    ) throws TorqueException
    {
		...
		if(isCacheEnabled() && isCacheForCriteriaSelectsEnabled())
		{		
							SimpleKey oKey = SimpleKey.keyFor(contentsourcetypeid);
     ...
     */		    
	    public static void doDelete(
   			int contentsourcetypeid				, Connection con) throws TorqueException
	{
		Criteria crit = new Criteria();
	   				crit.add(CONTENT_SOURCE_TYPE_ID, contentsourcetypeid);
				net.sf.iquiver.om.BaseContentSourceTypePeer.doDelete(crit, con);
    ...
    /**
     * Inserts or updates an ContentSourceType obj in the database<br>
     ...
     * @throws TorqueException
     */
	public static void doInsert(ContentSourceType obj) throws TorqueException
	{		
		removeObjectFromCache(obj.getPrimaryKey());
		net.sf.iquiver.om.BaseContentSourceTypePeer.doInsert(obj);
		if(obj != null)
		{
     ...
     * @throws TorqueException
     */
	public static void doInsert(ContentSourceType obj, Connection con) throws TorqueException
	{
		removeObjectFromCache(obj.getPrimaryKey());
		net.sf.iquiver.om.BaseContentSourceTypePeer.doInsert(obj, con);
		if(obj != null)
		{
			addObjectToCache(obj.getPrimaryKey(), obj);		
		}
