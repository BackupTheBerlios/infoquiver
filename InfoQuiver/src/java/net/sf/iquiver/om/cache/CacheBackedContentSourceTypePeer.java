...
{
	final private static Log logger = LogFactory.getLog(CacheBackedContentSourceTypePeer.class);
	
	final public static String CACHE_KEY = "net.sf.iquiver.om.ContentSourceType";
