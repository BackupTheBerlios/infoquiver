...
{
	final private static Log logger = LogFactory.getLog(CacheBackedTransportAttributePeer.class);
	
	final public static String CACHE_KEY = "net.sf.iquiver.om.TransportAttribute";
