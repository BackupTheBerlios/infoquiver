...
public abstract class BaseUser extends BaseObject
{
    ...
    /** The value for the userLastLogin field */
    ...
    public void setUserId(long v) throws TorqueException
    {
        ...
        // update associated UserContentSourceLnk
        if (collUserContentSourceLnks != null)
        {
            for (int i = 0; i < collUserContentSourceLnks.size(); i++)
            {
                ((UserContentSourceLnk) collUserContentSourceLnks.get(i))
                    .setUserId(v);
            }
        }
    ...
    /**
     * Set the value of UserLastLogin
     *
     * @param v new value
     */
    public void setUserLastLogin(long v) 
    {
    
                  if (this.userLastLogin != v)
              {
            this.userLastLogin = v;
            setModified(true);
        }
    ...
    /**
     * Collection to store aggregation of collUserContentSourceLnks
     */
    protected List collUserContentSourceLnks;

    /**
     * Temporary storage of collUserContentSourceLnks to save a possible db hit in
     * the event objects are add to the collection, but the
     * complete collection is never requested.
     */
    protected void initUserContentSourceLnks()
    {
        if (collUserContentSourceLnks == null)
        {
            collUserContentSourceLnks = new ArrayList();
        }
    }

    /**
     * Method called to associate a UserContentSourceLnk object to this object
     * through the UserContentSourceLnk foreign key attribute
     *
     * @param l UserContentSourceLnk
     * @throws TorqueException
     */
    public void addUserContentSourceLnk(UserContentSourceLnk l) throws TorqueException
    {
        getUserContentSourceLnks().add(l);
        l.setUser((User) this);
    }

    /**
     * The criteria used to select the current contents of collUserContentSourceLnks
     */
    private Criteria lastUserContentSourceLnksCriteria = null;

    /**
     * If this collection has already been initialized, returns
     * the collection. Otherwise returns the results of
     * getUserContentSourceLnks(new Criteria())
     *
     * @throws TorqueException
     */
    public List getUserContentSourceLnks() throws TorqueException
    {
        if (collUserContentSourceLnks == null)
        {
            collUserContentSourceLnks = getUserContentSourceLnks(new Criteria(10));
        }
        return collUserContentSourceLnks;
    }
     ...
     * been saved, it will retrieve related UserContentSourceLnks from storage.
     ...
     * @throws TorqueException
     */
    public List getUserContentSourceLnks(Criteria criteria) throws TorqueException
    {
        if (collUserContentSourceLnks == null)
        {
            if (isNew())
            ...
            {
                      criteria.add(UserContentSourceLnkPeer.USER_ID, getUserId() );
                      collUserContentSourceLnks = UserContentSourceLnkPeer.doSelect(criteria);
            }
        }
        else
        {
            ...
            if (!isNew())
            {
                ...
                // one, just return the collection.
                      criteria.add(UserContentSourceLnkPeer.USER_ID, getUserId());
                      if (!lastUserContentSourceLnksCriteria.equals(criteria))
                {
                    collUserContentSourceLnks = UserContentSourceLnkPeer.doSelect(criteria);
                }
            }
        }
        lastUserContentSourceLnksCriteria = criteria;
     ...
     * If this collection has already been initialized, returns
     * the collection. Otherwise returns the results of
     * getUserContentSourceLnks(new Criteria(),Connection)
     * This method takes in the Connection also as input so that
     * referenced objects can also be obtained using a Connection
     * that is taken as input
     */
    public List getUserContentSourceLnks(Connection con) throws TorqueException
    {
        if (collUserContentSourceLnks == null)
        {
            collUserContentSourceLnks = getUserContentSourceLnks(new Criteria(10), con);
        }
        return collUserContentSourceLnks;
    }
     ...
     * that is taken as input
     */
    public List getUserContentSourceLnks(Criteria criteria, Connection con)
            throws TorqueException
    {
        if (collUserContentSourceLnks == null)
        {
            ...
            {
                       criteria.add(UserContentSourceLnkPeer.USER_ID, getUserId());
                       collUserContentSourceLnks = UserContentSourceLnkPeer.doSelect(criteria, con);
             }
         }
         else
         {
     ...
     */
    protected List getUserContentSourceLnksJoinContentSource(Criteria criteria)
        throws TorqueException
    {
        if (collUserContentSourceLnks == null)
        {
            ...
            {
                            criteria.add(UserContentSourceLnkPeer.USER_ID, getUserId());
                            collUserContentSourceLnks = UserContentSourceLnkPeer.doSelectJoinContentSource(criteria);
            }
        }
        else
        {
     ...
     * actually need in User.
     */
    protected List getUserContentSourceLnksJoinUser(Criteria criteria)
        throws TorqueException
    {
        if (collUserContentSourceLnks == null)
        {
            ...
            {
                            criteria.add(UserContentSourceLnkPeer.USER_ID, getUserId());
                            collUserContentSourceLnks = UserContentSourceLnkPeer.doSelectJoinUser(criteria);
            }
        }
        else
        {
    ...
    public Object getByName(String name)
    {
          ...
          if (name.equals("UserPicture"))
        {
          ...
          if (name.equals("UserLastLogin"))
        {
                return new Long(getUserLastLogin());
            }
    ...
    public Object getByPeerName(String name)
    {
          ...
          if (name.equals(UserPeer.USER_PICTURE))
        {
          ...
          if (name.equals(UserPeer.USER_LAST_LOGIN))
        {
                return new Long(getUserLastLogin());
            }
    ...
    public void save(Connection con) throws TorqueException
    {
          if (!alreadyInSave)
        {
            ...
            if (collUserContentSourceLnks != null)
            {
                for (int i = 0; i < collUserContentSourceLnks.size(); i++)
                {
                    ((UserContentSourceLnk) collUserContentSourceLnks.get(i)).save(con);
                }
            }
    ...
    protected User copyInto(User copyObj) throws TorqueException
    {
          ...
          copyObj.setUserLastLogin(userLastLogin);
        ...
        List v = getUserContentSourceLnks();
        for (int i = 0; i < v.size(); i++)
        {
            UserContentSourceLnk obj = (UserContentSourceLnk) v.get(i);
            copyObj.addUserContentSourceLnk(obj.copy());
        }
    ...
    public String toString()
    {
        ...
        str.append("UserPicture = ")
           ...
           .append("\n");
        str.append("UserLastLogin = ")
           .append(getUserLastLogin())
           .append("\n");
