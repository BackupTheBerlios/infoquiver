        ...
        throws TorqueException
    {
        ...
        if (criteria.containsKey(IS_PART_OF_AUTHENTIFICATION))
        {
            ...
            if (possibleBoolean instanceof Boolean)
            {
                ...
                {
                    criteria.add(IS_PART_OF_AUTHENTIFICATION, 1);
                }
                else
                {
                    criteria.add(IS_PART_OF_AUTHENTIFICATION, 0);
                }
            }
         }
                  // check for conversion from boolean to int
        if (criteria.containsKey(IS_MANDATORY))
        {
            ...
            if (possibleBoolean instanceof Boolean)
            {
                if (((Boolean) possibleBoolean).booleanValue())
                {
                    criteria.add(IS_MANDATORY, 1);
                }
                else
                {
                    criteria.add(IS_MANDATORY, 0);
                }
            }
         }
        ...
        throws TorqueException
    {
        ...
        if (c.containsKey(IS_PART_OF_AUTHENTIFICATION))
        {
            ...
            if (possibleBoolean instanceof Boolean)
            {
                if (((Boolean) possibleBoolean).booleanValue())
                {
                    c.add(IS_PART_OF_AUTHENTIFICATION, 1);
                }
                else
                {
                    c.add(IS_PART_OF_AUTHENTIFICATION, 0);
                }
            }
         }
                                    // check for conversion from boolean to int
        if (c.containsKey(IS_MANDATORY))
        {
            ...
            if (possibleBoolean instanceof Boolean)
            {
                if (((Boolean) possibleBoolean).booleanValue())
                {
                    c.add(IS_MANDATORY, 1);
                }
                else
                {
                    c.add(IS_MANDATORY, 0);
                }
            }
         }
