...
public abstract class BaseContentSource extends BaseObject
{
    ...
    private long contentSourceUpdateTimespan = 1800000;
    ...
    public List getUserContentSourceLnks(Criteria criteria) throws TorqueException
    {
        if (collUserContentSourceLnks == null)
        {
            ...
            {
                      criteria.add(UserContentSourceLnkPeer.CONTENT_SOURCE_ID, getContentSourceId() );
    ...
    public List getClientContentSourceLnks(Criteria criteria) throws TorqueException
    {
        if (collClientContentSourceLnks == null)
        {
            ...
            {
                      criteria.add(ClientContentSourceLnkPeer.CONTENT_SOURCE_ID, getContentSourceId() );
    ...
    public Object getByPeerName(String name)
    {
          ...
          if (name.equals(ContentSourcePeer.TRANSPORT_ID))
        {
          ...
          if (name.equals(ContentSourcePeer.CONTENT_TYPE_ID))
        {
                return new Integer(getContentTypeId());
            }
    ...
    protected ContentSource copyInto(ContentSource copyObj) throws TorqueException
    {
        ...
        v = getContentSourceTransportConfigs();
        for (int i = 0; i < v.size(); i++)
        {
