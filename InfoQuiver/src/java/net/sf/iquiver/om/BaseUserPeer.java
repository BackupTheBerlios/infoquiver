    ...
    extends net.sf.iquiver.util.om.CacheBackedPeer
{
    ...
    public static final String USER_PICTURE;
      /** the column name for the USER_LAST_LOGIN field */
    public static final String USER_LAST_LOGIN;
    ...
    static
    {
          ...
          USER_LAST_LOGIN = "iq_user.USER_LAST_LOGIN";
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(USER_LAST_LOGIN);
        ...
        throws TorqueException
    {
        try
        {
                obj.setUserId(row.getValue(offset + 0).asLong());
                  ...
                  obj.setUserLastLogin(row.getValue(offset + 9).asLong());
                  obj.setAddressId(row.getValue(offset + 10).asLong());
                  obj.setClientId(row.getValue(offset + 11).asInt());
              }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
        ...
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
                criteria.add(USER_ID, obj.getUserId());
                  ...
                  criteria.add(USER_LAST_LOGIN, obj.getUserLastLogin());
