...
/**
 * The skeleton for this class was autogenerated by Torque on: [Sat Apr 03 11:46:39 CEST 2004]
 */
public interface IBaseWebService
{
    ...
    public net.sf.iquiver.om.User retrieveUserByPk();
    ...
    public net.sf.iquiver.om.Client retrieveClientByPk();
    ...
    public net.sf.iquiver.om.Address retrieveAddressByPk();
    ...
    public net.sf.iquiver.om.UserGroup retrieveUserGroupByPk();
    ...
    public net.sf.iquiver.om.UserGroupLnk retrieveUserGroupLnkByPk();
    ...
    public net.sf.iquiver.om.UserGroupClientLnk retrieveUserGroupClientLnkByPk();
    ...
    public net.sf.iquiver.om.Transport retrieveTransportByPk();
    ...
    public net.sf.iquiver.om.TransportAttribute retrieveTransportAttributeByPk();
    ...
    public net.sf.iquiver.om.ClientTransportLnk retrieveClientTransportLnkByPk();
    ...
    public net.sf.iquiver.om.Permission retrievePermissionByPk();
    ...
    public net.sf.iquiver.om.ClientPermissionLnk retrieveClientPermissionLnkByPk();
    ...
    public net.sf.iquiver.om.UserGroupPermissionLnk retrieveUserGroupPermissionLnkByPk();
    ...
    public net.sf.iquiver.om.ContentSourceType retrieveContentSourceTypeByPk();
    ...
    public net.sf.iquiver.om.Publisher retrievePublisherByPk();
    ...
    public net.sf.iquiver.om.ContentSource retrieveContentSourceByPk();
    ...
    public net.sf.iquiver.om.ContentSourceTransportConfig retrieveContentSourceTransportConfigByPk();
    ...
    public net.sf.iquiver.om.ContentParser retrieveContentParserByPk();
    ...
    public net.sf.iquiver.om.ContentType retrieveContentTypeByPk();
    ...
    public net.sf.iquiver.om.Content retrieveContentByPk();
    ...
    public net.sf.iquiver.om.ClientContentLnk retrieveClientContentLnkByPk();
