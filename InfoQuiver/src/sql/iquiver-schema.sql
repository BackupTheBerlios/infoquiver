...
(
		            ...
		            USER_PREFERED_REPORT_FORMAT VARCHAR (3),
...
(
		            ...
		            TRANSPORT_START_TIMEOUT INTEGER (32) default 60000,
...
(
		            ...
		            CONTENT_PARSER_ID INTEGER NOT NULL,
		            CONTENT_PARSER_ARGS VARCHAR (255),
...
(
		            ...
		            CONTENT_CONTENT LONGBLOB,
		            CONTENT_FILE_NAME VARCHAR (128),
		            CONTENT_TO_DELETE INTEGER,
    PRIMARY KEY(CONTENT_ID),
    FOREIGN KEY (CONTENT_PARENT_ID) REFERENCES iq_content (CONTENT_ID)
    ,
    FOREIGN KEY (CONTENT_SOURCE_ID) REFERENCES iq_content_source (CONTENT_SOURCE_ID)
    ,
    FOREIGN KEY (CONTENT_TYPE_ID) REFERENCES iq_content_type (CONTENT_TYPE_ID)
