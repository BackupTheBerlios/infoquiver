<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:include href="reports/inc_styles.xsl"/>
                    ...
                    <td>
                        <table>
                            <xsl:for-each select="/root/queryresult[$resultpos]/Document">
                                <xsl:variable name="fileURL"><xsl:value-of select="InfoUrl"/></xsl:variable>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td align="right">
                                        <a href="{$fileURL}" target="_blank"><xsl:value-of select="$fileURL"/></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
